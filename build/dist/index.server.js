var Li = "1.13.6", ci = typeof self == "object" && self.self === self && self || typeof global == "object" && global.global === global && global || Function("return this")() || {}, Ye = Array.prototype, Mn = Object.prototype, ui = typeof Symbol < "u" ? Symbol.prototype : null, zo = Ye.push, fe = Ye.slice, oe = Mn.toString, Ko = Mn.hasOwnProperty, $i = typeof ArrayBuffer < "u", qo = typeof DataView < "u", Mo = Array.isArray, li = Object.keys, fi = Object.create, hi = $i && ArrayBuffer.isView, Wo = isNaN, Jo = isFinite, Gi = !{ toString: null }.propertyIsEnumerable("toString"), gi = [
  "valueOf",
  "isPrototypeOf",
  "toString",
...
const Wn = y("String"), Ki = y("Number"), jo = y("Date"), Zo = y("RegExp"), tc = y("Error"), qi = y("Symbol"), Mi = y("ArrayBuffer");
var Wi = y("Function"), ec = ci.document && ci.document.childNodes;
typeof /./ != "function" && typeof Int8Array != "object" && typeof ec != "function" && (Wi = function(t) {
  return typeof t == "function" || !1;
});
const H = Wi, Ji = y("Object");
var Xi = qo && Ji(new DataView(new ArrayBuffer(8))), Jn = typeof Map < "u" && Ji(/* @__PURE__ */ new Map()), nc = y("DataView");
function rc(t) {
  return t != null && H(t.getInt8) && Mi(t.buffer);
}
const $e = Xi ? rc : nc, yt = Mo || y("Array");
function bt(t, e) {
...
const Xn = An;
function ic(t) {
  return !qi(t) && Jo(t) && !isNaN(parseFloat(t));
}
function Qi(t) {
  return Ki(t) && Wo(t);
}
...
function ji(t) {
  return function(e) {
    var n = t(e);
    return typeof n == "number" && n >= 0 && n <= Xo;
  };
}
function Zi(t) {
  return function(e) {
...
const Ge = Zi("byteLength"), sc = ji(Ge);
var ac = /\[object ((I|Ui)nt(8|16|32)|Float(32|64)|Uint8Clamped|Big(I|Ui)nt64)Array\]/;
function oc(t) {
  return hi ? hi(t) && !$e(t) : sc(t) && ac.test(oe.call(t));
}
const ts = $i ? oc : Yi(!1), q = Zi("length");
function cc(t) {
...
function es(t, e) {
  e = cc(e);
  var n = gi.length, r = t.constructor, i = H(r) && r.prototype || Mn, s = "constructor";
...
function uc(t) {
  if (t == null)
    return !0;
  var e = q(t);
  return typeof e == "number" && (yt(t) || Wn(t) || Xn(t)) ? e === 0 : q(T(t)) === 0;
}
function ns(t, e) {
  var n = T(e), r = n.length;
  if (t == null)
    return !r;
...
function rs(t, e, n, r) {
  ...
  if (!s) {
    ...
    if (o !== l && !(H(o) && o instanceof o && H(l) && l instanceof l) && "constructor" in t && "constructor" in e)
      return !1;
  }
  n = n || [], r = r || [];
...
var Yn = "forEach", is = "has", jn = ["clear", "delete"], ss = ["get", is, "set"], fc = jn.concat(Yn, ss), as = jn.concat(ss), hc = ["add"].concat(jn, Yn, is);
const gc = Jn ? Qn(fc) : y("Map"), dc = Jn ? Qn(as) : y("WeakMap"), pc = Jn ? Qn(hc) : y("Set"), mc = y("WeakSet");
function Xt(t) {
  for (var e = T(t), n = e.length, r = Array(n), i = 0; i < n; i++)
    r[i] = t[e[i]];
  return r;
}
function vc(t) {
...
function os(t) {
  for (var e = {}, n = T(t), r = 0, i = n.length; r < i; r++)
    e[t[n[r]]] = n[r];
  return e;
}
function yn(t) {
...
const cs = Zn(he), De = Zn(T), us = Zn(he, !0);
function bc() {
  return function() {
  };
}
...
function Sc(t) {
  return Ot(t) ? yt(t) ? t.slice() : cs({}, t) : t;
}
function kc(t, e) {
  return e(t), t;
}
...
function gs(t, e, n) {
  return t == null ? er : H(t) ? de(t, e, n) : Ot(t) && !yt(t) ? ce(t) : nr(t);
}
function rr(t, e) {
  return gs(t, e, 1 / 0);
}
w.iteratee = rr;
function M(t, e, n) {
  return w.iteratee !== rr ? w.iteratee(t, e) : gs(t, e, n);
}
function Ic(t, e, n) {
  e = M(e, n);
  for (var r = T(t), i = r.length, s = {}, a = 0; a < i; a++) {
    var o = r[a];
    s[o] = e(t[o], o, t);
  }
  return s;
...
function ps(t) {
  var e = function(s) {
    return t[s];
  }, n = "(?:" + T(t).join("|") + ")", r = RegExp(n), i = RegExp(n, "g");
  return function(s) {
...
const ms = {
  ...
  "'": "&#x27;",
  "`": "&#x60;"
}, Ec = ps(ms), Tc = os(ms), Nc = ps(Tc), Pc = w.templateSettings = {
  evaluate: /<%([\s\S]+?)%>/g,
  interpolate: /<%=([\s\S]+?)%>/g,
  escape: /<%-([\s\S]+?)%>/g
};
...
var Vc = /^\s*(\w|\$)+\s*$/;
function Rc(t, e, n) {
  !e && n && (e = n), e = us({}, e, w.templateSettings);
  var r = RegExp([
    (e.escape || Sn).source,
  ...
  t.replace(r, function(u, g, h, p, v) {
    return s += t.slice(i, v).replace(Oc, yc), i = v + u.length, g ? s += `'+
...
function Fc(t, e, n) {
  ...
  for (var i = 0; i < r; i++) {
    ...
    s === void 0 && (s = n, i = r), t = H(s) ? s.call(t) : s;
  }
  return t;
}
var Bc = 0;
...
function ks(t, e, n) {
  e = M(e, n);
  for (var r = T(t), i, s = 0, a = r.length; s < a; s++)
    if (i = r[s], e(t[i], i, t))
      return i;
}
function Cs(t) {
...
function _s(t, e, n) {
  return function(r, i, s) {
    ...
    if (i !== i)
      return s = e(fe.call(r, a, o), Qi), s >= 0 ? s + a : -1;
...
const Es = _s(1, Wt, xs), Jc = _s(-1, Is);
function ze(t, e, n) {
  var r = J(t) ? Wt : ks, i = r(t, e, n);
  if (i !== void 0 && i !== -1)
    return t[i];
}
function Xc(t, e) {
...
function Pt(t, e, n) {
  e = M(e, n);
  for (var r = !J(t) && T(t), i = (r || t).length, s = Array(i), a = 0; a < i; a++) {
    var o = r ? r[a] : a;
    s[a] = e(t[o], o, t);
  }
  return s;
...
function Ts(t) {
  var e = function(n, r, i, s) {
    var a = !J(n) && T(n), o = (a || n).length, l = t > 0 ? 0 : o - 1;
...
const kn = Ts(1), mi = Ts(-1);
function Jt(t, e, n) {
  var r = [];
  return e = M(e, n), ut(t, function(i, s, a) {
    e(i, s, a) && r.push(i);
  }), r;
}
function Qc(t, e, n) {
  return Jt(t, ir(M(e)), n);
}
function vi(t, e, n) {
  e = M(e, n);
  for (var r = !J(t) && T(t), i = (r || t).length, s = 0; s < i; s++) {
    var a = r ? r[s] : s;
    if (!e(t[a], a, t))
      return !1;
  }
...
function ct(t, e, n, r) {
  return J(t) || (t = Xt(t)), (typeof n != "number" || r) && (n = 0), Es(t, e, n) >= 0;
}
const Yc = K(function(t, e, n) {
  var r, i;
  return H(e) ? i = e : (e = ge(e), r = e.slice(0, -1), e = e[e.length - 1]), Pt(t, function(s) {
    var a = i;
    if (!a) {
...
var tu = /[^\ud800-\udfff]|[\ud800-\udbff][\udc00-\udfff]|[\ud800-\udfff]/g;
function Ps(t) {
  return t ? yt(t) ? fe.call(t) : Wn(t) ? t.match(tu) : J(t) ? Pt(t, er) : Xt(t) : [];
}
function As(t, e, n) {
  if (e == null || n)
    return J(t) || (t = Xt(t)), t[Vn(t.length - 1)];
  var r = Ps(t), i = q(r);
...
function nu(t, e, n) {
  var r = 0;
  return e = M(e, n), sr(Pt(t, function(i, s, a) {
    return {
      value: i,
      index: r++,
      criteria: e(i, s, a)
...
function je(t, e) {
  return function(n, r, i) {
    var s = e ? [[], []] : {};
    return r = M(r, i), ut(n, function(a, o) {
      var l = r(a, o, n);
      t(s, a, l);
    }), s;
  };
}
const ru = je(function(t, e, n) {
  bt(t, n) ? t[n].push(e) : t[n] = [e];
}), iu = je(function(t, e, n) {
  t[n] = e;
...
function ou(t) {
  return t == null ? 0 : J(t) ? t.length : T(t).length;
}
function cu(t, e, n) {
  return e in n;
}
const Os = K(function(t, e) {
  var n = {}, r = e[0];
  if (t == null)
    return n;
  H(r) ? (e.length > 1 && (r = de(r, e[1])), e = he(t)) : (r = cu, e = Vt(e, !1, !1), t = Object(t));
  ...
  var n = e[0], r;
  return H(n) ? (n = ir(n), e.length > 1 && (r = e[1])) : (e = Pt(Vt(e, !1, !1), String), n = function(i, s) {
    return !ct(e, s);
  }), Os(t, n, r);
});
function ys(t, e, n) {
...
const Vs = K(function(t, e) {
  return e = Vt(e, !0, !0), Jt(t, function(n) {
    return !ct(e, n);
  });
}), gu = K(function(t, e) {
  return Vs(t, e);
...
function Rn(t, e, n, r) {
  zi(e) || (r = n, n = e, e = !1), n != null && (n = M(n, r));
...
function Fn(t) {
  for (var e = t && Ns(t, q).length || 0, n = Array(e), r = 0; r < e; r++)
    n[r] = sr(t, r);
  return n;
}
const mu = K(Fn);
...
function Rs(t) {
  return ut(yn(t), function(e) {
    ...
    w.prototype[e] = function() {
      var r = [this._wrapped];
      return zo.apply(r, arguments), ar(this, n.apply(w, r));
    };
  }), w;
}
...
(function(t, e) {
  var n = 200, r = "__lodash_hash_undefined__", i = 9007199254740991, s = "[object Arguments]", a = "[object Array]", o = "[object Boolean]", l = "[object Date]", u = "[object Error]", g = "[object Function]", h = "[object GeneratorFunction]", p = "[object Map]", v = "[object Number]", b = "[object Object]", k = "[object Promise]", W = "[object RegExp]", O = "[object Set]", cn = "[object String]", I = "[object Symbol]", Yt = "[object WeakMap]", be = "[object ArrayBuffer]", we = "[object DataView]", Nr = "[object Float32Array]", Pr = "[object Float64Array]", Ar = "[object Int8Array]", Or = "[object Int16Array]", yr = "[object Int32Array]", Vr = "[object Uint8Array]", Rr = "[object Uint8ClampedArray]", Fr = "[object Uint16Array]", Br = "[object Uint32Array]", ba = /[\\^$.*+?()[\]{}|]/g, wa = /\w*$/, Sa = /^\[object .+?Constructor\]$/, ka = /^(?:0|[1-9]\d*)$/, C = {};
  C[s] = C[a] = C[be] = C[we] = C[o] = C[l] = C[Nr] = C[Pr] = C[Ar] = C[Or] = C[yr] = C[p] = C[v] = C[b] = C[W] = C[O] = C[cn] = C[I] = C[Vr] = C[Rr] = C[Fr] = C[Br] = !0, C[u] = C[g] = C[Yt] = !1;
  var Ca = typeof j == "object" && j && j.Object === Object && j, Ia = typeof self == "object" && self && self.Object === Object && self, at = Ca || Ia || Function("return this")(), Ur = e && !e.nodeType && e, Hr = Ur && !0 && t && !t.nodeType && t, xa = Hr && Hr.exports === Ur;
  function _a(c, f) {
  ...
  function Na(c, f) {
    for (var d = -1, m = f.length, P = c.length; ++d < m; )
      c[P + d] = f[d];
    return c;
  }
  function Lr(c, f, d, m) {
  ...
  var Oa = Array.prototype, ya = Function.prototype, Se = Object.prototype, ln = at["__core-js_shared__"], zr = function() {
    var c = /[^.]+$/.exec(ln && ln.keys && ln.keys.IE_PROTO || "");
    return c ? "Symbol(src)_1." + c : "";
  }(), Kr = ya.toString, lt = Se.hasOwnProperty, ke = Se.toString, Va = RegExp(
    "^" + Kr.call(lt).replace(ba, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
  ), qr = xa ? at.Buffer : void 0, Mr = at.Symbol, Wr = at.Uint8Array, Ra = un(Object.getPrototypeOf, Object), Fa = Object.create, Ba = Se.propertyIsEnumerable, Ua = Oa.splice, Jr = Object.getOwnPropertySymbols, Ha = qr ? qr.isBuffer : void 0, La = un(Object.keys, Object), fn = Bt(at, "DataView"), jt = Bt(at, "Map"), hn = Bt(at, "Promise"), gn = Bt(at, "Set"), dn = Bt(at, "WeakMap"), Zt = Bt(Object, "create"), $a = kt(fn), Ga = kt(jt), Da = kt(hn), za = kt(gn), Ka = kt(dn), Xr = Mr ? Mr.prototype : void 0, Qr = Xr ? Xr.valueOf : void 0;
  function wt(c) {
  ...
  wt.prototype.clear = qa, wt.prototype.delete = Ma, wt.prototype.get = Wa, wt.prototype.has = Ja, wt.prototype.set = Xa;
  function ot(c) {
    var f = -1, d = c ? c.length : 0;
    for (this.clear(); ++f < d; ) {
      var m = c[f];
  ...
  function Ya(c) {
    ...
    if (d < 0)
      return !1;
    var m = f.length - 1;
    return d == m ? f.pop() : Ua.call(f, d, 1), !0;
  }
  function ja(c) {
    var f = this.__data__, d = Ce(f, c);
  ...
  ot.prototype.clear = Qa, ot.prototype.delete = Ya, ot.prototype.get = ja, ot.prototype.has = Za, ot.prototype.set = to;
  function Rt(c) {
    var f = -1, d = c ? c.length : 0;
    for (this.clear(); ++f < d; ) {
      var m = c[f];
  ...
  Rt.prototype.clear = eo, Rt.prototype.delete = no, Rt.prototype.get = ro, Rt.prototype.has = io, Rt.prototype.set = so;
  function Ft(c) {
  ...
  Ft.prototype.clear = ao, Ft.prototype.delete = oo, Ft.prototype.get = co, Ft.prototype.has = uo, Ft.prototype.set = lo;
  function fo(c, f) {
    var d = vn(c) || Bo(c) ? Pa(c.length, String) : [], m = d.length, P = !!m;
    for (var V in c)
      (f || lt.call(c, V)) && !(P && (V == "length" || yo(V, m))) && d.push(V);
    return d;
  }
  function Yr(c, f, d) {
    var m = c[f];
  ...
  function pn(c, f, d, m, P, V, X) {
    var G;
    if (m && (G = V ? m(c, P, V, X) : m(c)), G !== void 0)
      return G;
    if (!xe(c))
      return c;
    var ii = vn(c);
    ...
    if (X.set(c, G), !ii)
      var oi = d ? No(c) : bn(c);
    return Ta(oi || c, function(wn, _e) {
      oi && (_e = wn, wn = c[_e]), Yr(G, _e, pn(wn, f, d, m, _e, c, X));
    }), G;
  }
  function go(c) {
    return xe(c) ? Fa(c) : {};
  ...
  function ko(c, f, d) {
    ...
    return Lr(m, _a, new c.constructor());
  }
  function Co(c) {
    var f = new c.constructor(c.source, wa.exec(c));
    return f.lastIndex = c.lastIndex, f;
  }
  function Io(c, f, d) {
    var m = f ? d(Dr(c), !0) : Dr(c);
    return Lr(m, Ea, new c.constructor());
  }
  function xo(c) {
  ...
  function jr(c, f, d, m) {
    d || (d = {});
    for (var P = -1, V = f.length; ++P < V; ) {
      var X = f[P], G = m ? m(d[X], c[X], X, d, c) : void 0;
      Yr(d, X, G === void 0 ? c[X] : G);
    }
    return d;
  }
  function To(c, f) {
  ...
  function Bt(c, f) {
    var d = Aa(c, f);
    return vo(d) ? d : void 0;
  }
  var Zr = Jr ? un(Jr, Object) : Go, St = mo;
  (fn && St(new fn(new ArrayBuffer(1))) != we || jt && St(new jt()) != p || hn && St(hn.resolve()) != k || gn && St(new gn()) != O || dn && St(new dn()) != Yt) && (St = function(c) {
  ...
  function Ao(c) {
    return typeof c.constructor == "function" && !ti(c) ? go(Ra(c)) : {};
  }
  function Oo(c, f, d, m) {
    var P = c.constructor;
    switch (f) {
  ...
  function yo(c, f) {
    return f = f ?? i, !!f && (typeof c == "number" || ka.test(c)) && c > -1 && c % 1 == 0 && c < f;
  }
  function Vo(c) {
    var f = typeof c;
  ...
  function Bo(c) {
    return Uo(c) && lt.call(c, "callee") && (!Ba.call(c, "callee") || ke.call(c) == s);
  }
  var vn = Array.isArray;
  function ni(c) {
    return c != null && Lo(c.length) && !ri(c);
  }
  function Uo(c) {
    return $o(c) && ni(c);
  }
...
function Au(t) {
  const e = {};
  return t.replace(Pu, "").split(Tu).forEach((n) => {
    if (n) {
      const r = n.split(Nu);
...
const ur = () => {
}, Ou = () => !1, yu = /^on[^a-z]/, Vu = (t) => yu.test(t), et = Object.assign, Ru = (t, e) => {
  const n = t.indexOf(e);
  n > -1 && t.splice(n, 1);
}, Fu = Object.prototype.hasOwnProperty, E = (t, e) => Fu.call(t, e), _ = Array.isArray, zt = (t) => tn(t) === "[object Map]", Bu = (t) => tn(t) === "[object Set]", L = (t) => typeof t == "function", nt = (t) => typeof t == "string", lr = (t) => typeof t == "symbol", z = (t) => t !== null && typeof t == "object", Uu = (t) => z(t) && L(t.then) && L(t.catch), Hu = Object.prototype.toString, tn = (t) => Hu.call(t), Bs = (t) => tn(t).slice(8, -1), Lu = (t) => tn(t) === "[object Object]", fr = (t) => nt(t) && t !== "NaN" && t[0] !== "-" && "" + parseInt(t, 10) === t, $u = (t) => {
  const e = /* @__PURE__ */ Object.create(null);
  return (n) => e[n] || (e[n] = t(n));
}, Th = $u((t) => t.charAt(0).toUpperCase() + t.slice(1)), Ke = (t, e) => !Object.is(t, e), Gu = (t, e, n) => {
...
let ki;
const zu = () => ki || (ki = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : typeof global < "u" ? global : {});
function Ci(t, ...e) {
}
let Ku;
function qu(t, e = Ku) {
...
const Un = (t) => {
...
}, Us = (t) => (t.w & mt) > 0, Hs = (t) => (t.n & mt) > 0, Mu = ({ deps: t }) => {
  if (t.length)
  ...
  if (e.length) {
    ...
    for (let r = 0; r < e.length; r++) {
      const i = e[r];
      Us(i) && !Hs(i) ? i.delete(t) : e[n++] = i, i.w &= ~mt, i.n &= ~mt;
    }
    e.length = n;
  }
...
class Ju {
  ...
  run() {
    ...
    try {
      return this.parent = D, D = this, _t = !0, mt = 1 << ++ne, ne <= Ln ? Mu(this) : Ii(this), this.fn();
    } finally {
      ne <= Ln && Wu(this), mt = 1 << --ne, D = this.parent, _t = n, this.parent = void 0, this.deferStop && this.stop();
    }
  }
  stop() {
...
function Xu(t, e) {
  let n = !1;
  ne <= Ln ? Hs(t) || (t.n |= mt, n = !Us(t)) : n = !t.has(D), n && (t.add(D), D.deps.push(t), process.env.NODE_ENV !== "production" && D.onTrack && D.onTrack(Object.assign({ effect: D }, e)));
}
function vt(t, e, n, r, i, s) {
  ...
  if (e === "clear")
    ...
    switch (n !== void 0 && o.push(a.get(n)), e) {
      case "add":
        _(t) ? fr(n) && o.push(a.get("length")) : (o.push(a.get(xt)), zt(t) && o.push(a.get($n)));
        break;
      case "delete":
        _(t) || (o.push(a.get(xt)), zt(t) && o.push(a.get($n)));
        break;
      case "set":
        zt(t) && o.push(a.get(xt));
        break;
    }
...
const Qu = /* @__PURE__ */ Eu("__proto__,__v_isRef,__isVue"), Ds = new Set(
  /* @__PURE__ */ Object.getOwnPropertyNames(Symbol).filter((t) => t !== "arguments" && t !== "caller").map((t) => Symbol[t]).filter(lr)
), Yu = /* @__PURE__ */ hr(), ju = /* @__PURE__ */ hr(!0), Zu = /* @__PURE__ */ hr(!0, !0), _i = /* @__PURE__ */ tl();
function tl() {
  const t = {};
...
function hr(t = !1, e = !1) {
  return function(r, i, s) {
    ...
    if (i === "__v_isShallow")
      return e;
    if (i === "__v_raw" && s === (t ? e ? Ws : Ms : e ? ml : qs).get(r))
      return r;
    const a = _(r);
    if (!t && a && E(_i, i))
      return Reflect.get(_i, i, s);
    const o = Reflect.get(r, i, s);
    return (lr(i) ? Ds.has(i) : Qu(i)) || (t || Z(r, "get", i), e) ? o : U(o) ? a && fr(i) ? o : o.value : z(o) ? t ? Xs(o) : Js(o) : o;
  };
}
...
function nl(t = !1) {
  return function(n, r, i, s) {
    ...
    if (At(a) && U(a) && !U(i))
      return !1;
    if (!t && (!Gn(i) && !At(i) && (a = S(a), i = S(i)), !_(n) && U(a) && !U(i)))
      return a.value = i, !0;
    const o = _(n) && fr(r) ? Number(r) < n.length : E(n, r), l = Reflect.set(n, r, i, s);
    return n === S(s) && (o ? Ke(i, a) && vt(n, "set", r, i, a) : vt(n, "add", r, i)), l;
  };
}
function rl(t, e) {
  const n = E(t, e), r = t[e], i = Reflect.deleteProperty(t, e);
  return i && n && vt(t, "delete", e, void 0, r), i;
}
function il(t, e) {
  const n = Reflect.has(t, e);
  return (!lr(e) || !Ds.has(e)) && Z(t, "has", e), n;
}
function sl(t) {
  return Z(t, "iterate", _(t) ? "length" : xt), Reflect.ownKeys(t);
}
const al = {
  get: Yu,
  set: el,
...
function Ti(t, e) {
  ...
  const a = i.call(n, t);
  return n.set(t, e), s ? Ke(e, a) && vt(n, "set", t, e, a) : vt(n, "add", t, e), this;
}
function Ni(t) {
...
function Pi() {
  const t = S(this), e = t.size !== 0, n = process.env.NODE_ENV !== "production" ? zt(t) ? new Map(t) : new Set(t) : void 0, r = t.clear();
  return e && vt(t, "clear", void 0, void 0, n), r;
}
function Oe(t, e) {
  return function(r, i) {
    const s = this, a = s.__v_raw, o = S(a), l = e ? gr : t ? vr : mr;
    return !t && Z(o, "iterate", xt), a.forEach((u, g) => r.call(i, l(u), l(g), s));
  };
}
function ye(t, e, n) {
  return function(...r) {
    const i = this.__v_raw, s = S(i), a = zt(s), o = t === "entries" || t === Symbol.iterator && a, l = t === "keys" && a, u = i[t](...r), g = n ? gr : e ? vr : mr;
...
function dr(t, e) {
  ...
  return (r, i, s) => i === "__v_isReactive" ? !t : i === "__v_isReadonly" ? t : i === "__v_raw" ? r : Reflect.get(E(n, i) && i in r ? n : r, i, s);
}
const gl = {
  get: /* @__PURE__ */ dr(!1, !1)
}, dl = {
...
const qs = /* @__PURE__ */ new WeakMap(), ml = /* @__PURE__ */ new WeakMap(), Ms = /* @__PURE__ */ new WeakMap(), Ws = /* @__PURE__ */ new WeakMap();
function vl(t) {
  switch (t) {
    case "Object":
    case "Array":
...
function bl(t) {
  return t.__v_skip || !Object.isExtensible(t) ? 0 : vl(Bs(t));
}
function Js(t) {
  return At(t) ? t : pr(t, !1, al, gl, qs);
}
function Xs(t) {
  return pr(t, !0, zs, dl, Ms);
}
function Ve(t) {
  return pr(t, !0, ol, pl, Ws);
}
...
function wl(t) {
  return Gu(t, "__v_skip", !0), t;
}
const mr = (t) => z(t) ? Js(t) : t, vr = (t) => z(t) ? Xs(t) : t;
function U(t) {
...
function B(t, ...e) {
  if (process.env.NODE_ENV === "production")
    return;
  $s();
  const n = Tt.length ? Tt[Tt.length - 1].component : null, r = n && n.appContext.config.warnHandler, i = _l();
  if (r)
    Nt(r, n, 11, [
      t + e.join(""),
      n && n.proxy,
      i.map(({ vnode: s }) => `at <${la(n, s.type)}>`).join(`
`),
      i
    ]);
  else {
...
function Tl({ vnode: t, recurseCount: e }) {
  const n = e > 0 ? `... (${e} recursive calls)` : "", r = t.component ? t.component.parent == null : !1, i = ` at <${la(t.component, t.type, r)}`, s = ">" + n;
...
function Qs(t, e, n) {
  return nt(e) ? (e = JSON.stringify(e), n ? e : [`${t}=${e}`]) : typeof e == "number" || typeof e == "boolean" || e == null ? n ? e : [`${t}=${e}`] : U(e) ? (e = Qs(t, S(e.value), !0), n ? e : [`${t}=Ref<`, e, ">"]) : L(e) ? [`${t}=fn${e.name ? `<${e.name}>` : ""}`] : (e = S(e), n ? e : [`${t}=`, e]);
}
const Ys = {
...
function js(t, e, n, r = !0) {
  ...
  if (e) {
    let s = e.parent;
    const a = e.proxy, o = process.env.NODE_ENV !== "production" ? Ys[n] : n;
    for (; s; ) {
      const u = s.ec;
      if (u) {
...
function Pl(t, e, n, r = !0) {
  if (process.env.NODE_ENV !== "production") {
    const i = Ys[e];
    if (n && Il(n), B(`Unhandled error${i ? ` during execution of ${i}` : ""}`), n && xl(), r)
      throw t;
  }
}
let Me = !1, zn = !1;
...
function wr(t) {
  (!tt.length || !tt.includes(t, Me && t.allowRecurse ? gt + 1 : gt)) && (t.id == null ? tt.push(t) : tt.splice(yl(t.id), 0, t), ta());
}
function ta() {
  !Me && !zn && (zn = !0, br = Zs.then(na));
}
function ea(t) {
  _(t) ? Kt.push(...t) : (!it || !it.includes(t, t.allowRecurse ? ht + 1 : ht)) && Kt.push(t), ta();
}
function Vl(t) {
  if (Kt.length) {
    const e = [...new Set(Kt)];
    ...
    for (it = e, process.env.NODE_ENV !== "production" && (t = t || /* @__PURE__ */ new Map()), it.sort((n, r) => le(n) - le(r)), ht = 0; ht < it.length; ht++)
      process.env.NODE_ENV !== "production" && ra(t, it[ht]) || it[ht]();
    it = null, ht = 0;
  }
}
const le = (t) => t.id == null ? 1 / 0 : t.id, Rl = (t, e) => {
  const n = le(t) - le(e);
  if (n === 0) {
    if (t.pre && !e.pre)
      return -1;
...
function na(t) {
  zn = !1, Me = !0, process.env.NODE_ENV !== "production" && (t = t || /* @__PURE__ */ new Map()), tt.sort(Rl);
  const e = process.env.NODE_ENV !== "production" ? (n) => ra(t, n) : ur;
  try {
    ...
    gt = 0, tt.length = 0, Vl(t), Me = !1, br = null, (tt.length || Kt.length) && na(t);
  }
}
function ra(t, e) {
  if (!t.has(e))
    ...
    const n = t.get(e);
    if (n > Al) {
      const r = e.ownerInstance, i = r && ua(r.type);
...
function Ul(t, e) {
  ...
  for (const i of r) {
    const s = ie(i.type);
    ee.has(s) || (s !== n.initialDef && Ai(s, e), ee.add(s)), i.appContext.optionsCache.delete(i.type), i.ceReload ? (ee.add(s), i.ceReload(e.styles), ee.delete(s)) : i.parent ? wr(i.parent.update) : i.appContext.reload ? i.appContext.reload() : typeof window < "u" && window.location.reload();
  }
  ea(() => {
    for (const i of r)
      ee.delete(ie(i.type));
...
function $l(t, e) {
  e && e.pendingBranch ? _(t) ? e.effects.push(...t) : e.effects.push(t) : ea(t);
}
const Re = {};
function Gl(t, e, { immediate: n, deep: r, flush: i, onTrack: s, onTrigger: a } = st) {
  ...
  let u, g = !1, h = !1;
  if (U(t) ? (u = () => t.value, g = Gn(t)) : Et(t) ? (u = () => t, r = !0) : _(t) ? (h = !0, g = t.some((I) => Et(I) || Gn(I)), u = () => t.map((I) => {
    if (U(I))
      return I.value;
    if (Et(I))
      return $t(I);
  ...
  const k = () => {
    if (!!O.active)
      if (e) {
        const I = O.run();
        (r || g || (h ? I.some((Yt, be) => Ke(Yt, b[be])) : Ke(I, b))) && (p && p(), Dn(e, l, 3, [
          I,
  ...
  k.allowRecurse = !!e;
  let W;
  i === "sync" ? W = k : i === "post" ? W = () => Vi(k, l && l.suspense) : (k.pre = !0, l && (k.id = l.uid), W = () => wr(k));
  const O = new Ju(u, W);
  return process.env.NODE_ENV !== "production" && (O.onTrack = s, O.onTrigger = a), e ? n ? k() : b = O.run() : i === "post" ? Vi(O.run.bind(O), l && l.suspense) : O.run(), () => {
    O.stop(), l && l.scope && Ru(l.scope.effects, O);
  };
}
function Dl(t, e, n) {
  const r = this.proxy, i = nt(t) ? t.includes(".") ? zl(r, t) : () => r[t] : t.bind(r, r);
  let s;
  L(e) ? s = e : (s = e.handler, n = e);
  const a = qt;
  Ri(this);
  const o = Gl(i, s.bind(r), n);
  return a ? Ri(a) : lf(), o;
}
function zl(t, e) {
  const n = e.split(".");
...
const Kl = Symbol(), Kn = (t) => t ? ff(t) ? hf(t) || t.proxy : Kn(t.parent) : null, se = /* @__PURE__ */ et(/* @__PURE__ */ Object.create(null), {
  ...
  $watch: (t) => __VUE_OPTIONS_API__ ? Dl.bind(t) : ur
}), ql = (t) => t === "_" || t === "$", xn = (t, e) => t !== st && !t.__isScriptSetup && E(t, e), Ml = {
  get({ _: t }, e) {
    ...
    if (e[0] !== "$") {
      ...
      if (v !== void 0)
        ...
        if (i !== st && E(i, e))
          return a[e] = 2, i[e];
        if ((u = t.propsOptions[0]) && E(u, e))
          return a[e] = 3, s[e];
        if (n !== st && E(n, e))
          return a[e] = 4, n[e];
        (!__VUE_OPTIONS_API__ || Wl) && (a[e] = 0);
      }
    }
    const g = se[e];
    let h, p;
    ...
    if (n !== st && E(n, e))
      return a[e] = 4, n[e];
    if (p = l.config.globalProperties, E(p, e))
      return p[e];
    process.env.NODE_ENV !== "production" && dt && (!nt(e) || e.indexOf("__v") !== 0) && (i !== st && ql(e[0]) && E(i, e) ? B(`Property ${JSON.stringify(e)} must be accessed via $data because it starts with a reserved character ("$" or "_") and is not proxied on the render context.`) : t === dt && B(`Property ${JSON.stringify(e)} was accessed during render but is not defined on instance.`));
  },
  set({ _: t }, e, n) {
    const { data: r, setupState: i, ctx: s } = t;
    return xn(i, e) ? (i[e] = n, !0) : process.env.NODE_ENV !== "production" && i.__isScriptSetup && E(i, e) ? (B(`Cannot mutate <script setup> binding "${e}" from Options API.`), !1) : r !== st && E(r, e) ? (r[e] = n, !0) : E(t.props, e) ? (process.env.NODE_ENV !== "production" && B(`Attempting to mutate prop "${e}". Props are readonly.`), !1) : e[0] === "$" && e.slice(1) in t ? (process.env.NODE_ENV !== "production" && B(`Attempting to mutate public property "${e}". Properties starting with $ are reserved and readonly.`), !1) : (process.env.NODE_ENV !== "production" && e in t.appContext.config.globalProperties ? Object.defineProperty(s, e, {
      enumerable: !0,
      configurable: !0,
      value: n
    }) : s[e] = n, !0);
  ...
  has({ _: { data: t, setupState: e, accessCache: n, ctx: r, appContext: i, propsOptions: s } }, a) {
    let o;
    return !!n[a] || t !== st && E(t, a) || xn(e, a) || (o = s[0]) && E(o, a) || E(r, a) || E(se, a) || E(i.config.globalProperties, a);
  },
  defineProperty(t, e, n) {
    return n.get != null ? t._.accessCache[e] = 0 : E(n, "value") && this.set(t, e, n.value, null), Reflect.defineProperty(t, e, n);
  }
};
process.env.NODE_ENV !== "production" && (Ml.ownKeys = (t) => (B("Avoid app logic that relies on enumerating keys on a component instance. The keys will be empty in production mode to avoid performance overhead."), Reflect.ownKeys(t)));
let Wl = !0;
function Jl(t) {
...
function Oi(t, e) {
  return e ? t ? function() {
    return et(L(t) ? t.call(this, this) : t, L(e) ? e.call(this, this) : e);
  } : e : t;
}
function Ql(t, e) {
  return It(yi(t), yi(e));
...
const Vi = $l, Zl = (t) => t.__isTeleport, ia = Symbol(process.env.NODE_ENV !== "production" ? "Fragment" : void 0), tf = Symbol(process.env.NODE_ENV !== "production" ? "Text" : void 0), ef = Symbol(process.env.NODE_ENV !== "production" ? "Comment" : void 0);
Symbol(process.env.NODE_ENV !== "production" ? "Static" : void 0);
let Gt = null;
function nf(t) {
  return t ? t.__v_isVNode === !0 : !1;
}
const rf = (...t) => oa(...t), sa = "__vInternal", aa = ({ key: t }) => t ?? null, Le = ({ ref: t, ref_key: e, ref_for: n }) => t != null ? nt(t) || U(t) || L(t) ? { i: dt, r: t, k: e, f: !!n } : t : null;
function sf(t, e = null, n = null, r = 0, i = null, s = t === ia ? 0 : 1, a = !1, o = !1) {
  const l = {
    __v_isVNode: !0,
    __v_skip: !0,
    type: t,
  ...
  return o ? (Sr(l, n), s & 128 && t.normalize(l)) : n && (l.shapeFlag |= nt(n) ? 8 : 16), process.env.NODE_ENV !== "production" && l.key !== l.key && B("VNode created with invalid key (NaN). VNode type:", l.type), !a && Gt && (l.patchFlag > 0 || s & 6) && l.patchFlag !== 32 && Gt.push(l), l;
}
const af = process.env.NODE_ENV !== "production" ? rf : oa;
function oa(t, e = null, n = null, r = 0, i = null, s = !1) {
  if ((!t || t === Kl) && (process.env.NODE_ENV !== "production" && !t && B(`Invalid vnode type when creating vnode: ${t}.`), t = ef), nf(t)) {
    const o = Xe(t, e, !0);
    return n && Sr(o, n), !s && Gt && (o.shapeFlag & 6 ? Gt[Gt.indexOf(t)] = o : Gt.push(o)), o.patchFlag |= -2, o;
  }
  if (fa(t) && (t = t.__vccOpts), e) {
    e = of(e);
    let { class: o, style: l } = e;
    o && !nt(o) && (e.class = cr(o)), z(l) && (qe(l) && !_(l) && (l = et({}, l)), e.style = or(l));
  }
  const a = nt(t) ? 1 : Ll(t) ? 128 : Zl(t) ? 64 : z(t) ? 4 : L(t) ? 2 : 0;
  return process.env.NODE_ENV !== "production" && a & 4 && qe(t) && (t = S(t), B("Vue received a Component which was made a reactive object. This can lead to unnecessary performance overhead, and should be avoided by marking the component with `markRaw` or using `shallowRef` instead of `ref`.", `
Component that was made reactive: `, t)), sf(t, e, n, r, i, a, s, !0);
}
function of(t) {
  return t ? qe(t) || sa in t ? et({}, t) : t : null;
}
function Xe(t, e, n = !1) {
  const { props: r, ref: i, patchFlag: s, children: a } = t, o = e ? uf(r || {}, e) : r;
  return {
    __v_isVNode: !0,
    __v_skip: !0,
    type: t.type,
    props: o,
    key: o && aa(o),
    ref: e && e.ref ? n && i ? _(i) ? i.concat(Le(e)) : [i, Le(e)] : Le(e) : i,
    scopeId: t.scopeId,
    slotScopeIds: t.slotScopeIds,
    children: process.env.NODE_ENV !== "production" && s === -1 && _(a) ? a.map(ca) : a,
    target: t.target,
    targetAnchor: t.targetAnchor,
    staticCount: t.staticCount,
    shapeFlag: t.shapeFlag,
    patchFlag: e && t.type !== ia ? s === -1 ? 16 : s | 16 : s,
...
function ca(t) {
  const e = Xe(t);
  return _(t.children) && (e.children = t.children.map(ca)), e;
}
function cf(t = " ", e = 0) {
  return af(tf, null, t, e);
}
function Sr(t, e) {
  let n = 0;
  const { shapeFlag: r } = t;
  if (e == null)
    ...
    if (r & 65) {
      ...
      n = 32;
      const i = e._;
      !i && !(sa in e) ? e._ctx = dt : i === 3 && dt && (dt.slots._ === 1 ? e._ = 1 : (e._ = 2, t.patchFlag |= 1024));
    }
  else
    L(e) ? (e = { default: e, _ctx: dt }, n = 32) : (e = String(e), r & 64 ? (n = 16, e = [cf(e)]) : n = 8);
  ...
  for (let n = 0; n < t.length; n++) {
    ...
    for (const i in r)
      if (i === "class")
        ...
        const s = e[i], a = r[i];
        a && s !== a && !(_(s) && s.includes(a)) && (e[i] = s ? [].concat(s, a) : a);
      } else
        i !== "" && (e[i] = r[i]);
  }
  return e;
...
function hf(t) {
  if (t.exposed)
    return t.exposeProxy || (t.exposeProxy = new Proxy(Cl(wl(t.exposed)), {
      get(e, n) {
        if (n in e)
          return e[n];
        if (n in se)
...
const gf = /(?:^|[-_])(\w)/g, df = (t) => t.replace(gf, (e) => e.toUpperCase()).replace(/[-_]/g, "");
function ua(t, e = !0) {
...
function pf() {
  ...
  function o(h, p = !0) {
    return typeof h == "number" ? ["span", e, h] : typeof h == "string" ? ["span", n, JSON.stringify(h)] : typeof h == "boolean" ? ["span", r, h] : z(h) ? ["object", { object: p ? S(h) : h }] : ["span", n, String(h)];
  }
  function l(h, p) {
    const v = h.type;
    if (L(v))
  ...
  function u(h, p, v) {
    const b = h[v];
    if (_(b) && b.includes(p) || z(b) && p in b || h.extends && u(h.extends, p, v) || h.mixins && h.mixins.some((k) => u(k, p, v)))
      return !0;
  }
  function g(h) {
...
function Nh(t) {
  ...
  return vf(t) + e.toString();
}
const bf = /^([a-g]{1}(?:b|#|x|bb)?)(-?[0-9]+)/i, wf = {
  cbb: -2,
  cb: -1,
  c: 0,
  "c#": 1,
...
class Y {
  ...
  constructor({
    ...
    if (this.song = e, this.track = s, this.id = i, this.type = n, this.notes = [], n === 2) {
      ...
      (!A.isNumber(a) || l < a) && (a = l), this.clipStartTick = r, this.clipEndTick = a;
    } else if (n === 1) {
  ...
  moveClip(e, n) {
    ...
    if (this.type === 1) {
      ...
      const o = this.song, l = o.tickToSeconds(this.audioClipData.startTick), u = o.tickToSeconds(s), h = o.tickToSeconds(a) - u, p = u - l, v = o.tickToSeconds(this.clipStartTick + e), b = v - p, k = v + h;
      if (this.clipStartTick = r, this.clipEndTick = o.secondsToTick(k), this.audioClipData.startTick = o.secondsToTick(b), this.clipEndTick < 0) {
        this.deleteFromParent(!0);
        return;
      }
    }
...
class Mt {
  ...
  getPointsInRange(e, n) {
    return Mt.getPointsInRangeImpl(this.points, e, n);
  }
  ...
  addPoint(e, n, r = !1) {
    ...
    return Mt.orderedInsertPointInternal(this.points, i, r), i;
  }
  removePoints(e) {
    const n = new Set(e);
    ...
    if (!(a === void 0 || o === void 0)) {
      if (i) {
        if (n < 0) {
          ...
          const u = this.points[o].tick + n, g = x.lt(
            this.points,
            { tick: u },
            (h, p) => h.tick - p.tick
          );
...
class kr {
  ...
  getOrCreateAutomationValueById(e) {
    return this.targetValues[e] || (this.targetValues[e] = new Mt()), this.targetValues[e];
  }
  ...
  addAutomation(e, n = 0) {
    ...
    this.getAutomationValueById(r) || (this.targetValues[r] = new Mt());
  }
  removeAutomation(e) {
...
var Lt = /* @__PURE__ */ ((t) => (t[t.MIDI_TRACK = 1] = "MIDI_TRACK", t[t.AUDIO_TRACK = 2] = "AUDIO_TRACK", t[t.MASTER_TRACK = 3] = "MASTER_TRACK", t))(Lt || {});
class Dt {
  insturment;
  clips;
  ...
  constructor({
    type: e,
    song: n,
    uuid: r = Dt.generateTrackIdInternal(),
    clips: i = [],
    instrument: s,
...
function Vf(t, e, n) {
  ...
  for (i = 0; i < s; i++)
    (n.running === !1 || !n.running && !e[i].running) && (a = null), a = Rf(r, e[i], a, n.useByte9ForNoteOff);
...
function Rf(t, e, n, r) {
  ...
  switch (t.writeVarInt(s), i) {
    ...
    case "pitchBend":
      ...
      var v = 8192 + e.value, b = v & 127, k = v >> 7 & 127;
      t.writeUInt8(b), t.writeUInt8(k);
      break;
    default:
...
function pa(t, e) {
  for (var n = 0; n < t.length; n++) {
    var r = t[n];
    Array.isArray(r) ? pa(r, e) : e.push(r);
  }
  return e;
}
function ma(t, e, n) {
  ...
  for (var r = 0; r < t.length; r++) {
    var i = t[r];
    n > -1 && Array.isArray(i) ? ma(i, e, n) : e.push(i);
  }
  return e;
}
var En = j && j.__spreadArrays || function() {
  ...
  for (var r = Array(t), i = 0, e = 0; e < n; e++)
    for (var s = arguments[e], a = 0, o = s.length; a < o; a++, i++)
      r[i] = s[a];
  return r;
}, Lf = j && j.__importDefault || function(t) {
  return t && t.__esModule ? t : { default: t };
};
Object.defineProperty(Cr, "__esModule", { value: !0 });
var $f = sn, Gf = an, Df = Lf(me.exports);
function zf(t, e) {
  return [
    {
...
function Kf(t) {
  return Df.default(t.notes.map(function(e) {
    return zf(e, t.channel);
  }));
}
function qf(t, e) {
  return {
...
function Zf(t) {
  var e = Gf.keySignatureKeys.indexOf(t.key);
  return {
    absoluteTime: t.ticks,
    deltaTime: 0,
    key: e + 7,
...
xr.createControlChanges = nh;
var _r = {};
Object.defineProperty(_r, "__esModule", { value: !0 });
var Tn = /* @__PURE__ */ new WeakMap(), rh = function() {
  function t(e, n) {
...
var Be = ve, Bi = /* @__PURE__ */ new WeakMap(), ih = function() {
  function t(e, n) {
    if (this.number = 0, Bi.set(this, n), this.number = 0, e) {
...
var oh = function() {
...
}(), Ht = /* @__PURE__ */ new WeakMap(), ch = function() {
  function t(e, n, r) {
  ...
  return Object.defineProperty(t.prototype, "name", {
    ...
    set: function(e) {
      this.midi = 12 * (this.octave + 1) + ah(e);
    },
    enumerable: !0,
    configurable: !0
...
var Nn = pe, uh = Ir, lh = xr, fh = _r, Ui = Er, hh = Tr, Ue = /* @__PURE__ */ new WeakMap(), gh = function() {
  function t(e, n) {
    var r = this;
    if (this.name = "", this.notes = [], this.controlChanges = lh.createControlChanges(), this.pitchBends = [], Ue.set(this, n), e) {
      var i = e.find(function(p) {
        return p.type === "trackName";
      });
      this.name = i ? i.text : "";
    }
    if (this.instrument = new Ui.Instrument(e, this), this.channel = 0, e) {
      for (var s = e.filter(function(p) {
        ...
        var p = s.shift();
        l.channel = p.channel;
        var v = a.findIndex(function(k) {
          return k.noteNumber === p.noteNumber && k.absoluteTime >= p.absoluteTime;
        });
        if (v !== -1) {
  ...
  return t.prototype.addNote = function(e) {
    var n = Ue.get(this), r = new hh.Note({
      midi: 0,
      ticks: 0,
      velocity: 1
    }, {
    ...
    var n = Ue.get(this), r = new uh.ControlChange({
    ...
    var n = Ue.get(this), r = new fh.PitchBend({}, n);
    ...
    var n = this;
    this.name = e.name, this.channel = e.channel, this.instrument = new Ui.Instrument(void 0, this), this.instrument.fromJSON(e.instrument), e.endOfTrackTicks !== void 0 && (this.endOfTrackTicks = e.endOfTrackTicks);
...
on.Track = gh;
var dh = j && j.__awaiter || function(t, e, n, r) {
  function i(s) {
...
}, ph = j && j.__generator || function(t, e) {
...
var mh = sn, vh = Cr, Hi = an, Pn = on, bh = function() {
  function t(e) {
    var n = this, r = null;
    e && (e instanceof ArrayBuffer && (e = new Uint8Array(e)), r = mh.parseMidi(e), r.tracks.forEach(function(i) {
      var s = 0;
      i.forEach(function(a) {
        s += a.deltaTime, a.absoluteTime = s;
      });
    }), r.tracks = Ch(r.tracks)), this.header = new Hi.Header(r), this.tracks = [], e && (this.tracks = r.tracks.map(function(i) {
...
var Ih = /* @__PURE__ */ ((t) => (t[t.UNKNOWN = 0] = "UNKNOWN", t[t.INTRO = 1] = "INTRO", t[t.VERSE = 2] = "VERSE", t[t.CHORUS = 3] = "CHORUS", t[t.BRIDGE = 4] = "BRIDGE", t[t.OUTRO = 5] = "OUTRO", t))(Ih || {});
class xh {
  tick;
  type;
...
class rt {
  ...
  getMasterTrack() {
    return this.masterTrack || (this.masterTrack = new Dt({
      type: Lt.MASTER_TRACK,
      song: this,
      uuid: Dt.generateTrackIdInternal()
    })), this.masterTrack;
  }
  getTracks() {
    return this.tracks;
  ...
  createTrack({
    ...
    return i && e === Lt.MIDI_TRACK && s.setSamplerPlugin(s.createAudioPlugin(nn.DEFAULT_SYNTH_TFID)), n != null ? this.tracks.splice(n, 0, s) : this.tracks.push(s), s;
  }
  cloneTrack(e) {
    ...
    if (r.setVolume(e.getVolume()), r.setPan(e.getPan()), r.setSolo(e.getSolo()), r.setMuted(e.getMuted()), e.getType() === Lt.MIDI_TRACK) {
  ...
  createTempoChange({
    ...
    const r = new Ee({ ticks: e, bpm: n, time: this.tickToSeconds(e) }), i = x.ge(
      this.tempos,
      r,
  ...
  createTimeSignature({
    ...
    const i = new Si({ ticks: e, numerator: n, denominator: r }), s = x.ge(
      this.timeSignatures,
      i,
  ...
  static importMIDI(e, n, r = 0, i = !1) {
    const s = new wh(n), a = r, o = rt.DEFAULT_PPQ / s.header.ppq;
    if (i) {
      const l = [];
      for (const g of s.header.timeSignatures)
        l.push(
          new Si({
            ticks: a + Ct(g.ticks, o),
    ...
    for (const l of s.tracks) {
      ...
      const g = u.createMIDIClip({ clipStartTick: a });
      let h = Number.MAX_SAFE_INTEGER;
      for (const b of l.notes)
        g.createNote({
          pitch: b.midi,
          velocity: Math.round(b.velocity * 127),
          startTick: a + Ct(b.ticks, o),
          endTick: a + Ct(b.ticks + b.durationTicks, o)
        }), h = Math.min(
          h,
          a + Ct(b.ticks, o)
        );
      const p = l.controlChanges[7];
      if (p)
        if (p.length === 1)
          u.setVolume(p[0].value);
        else {
          const b = new Q(qn.VOLUME);
          u.getAutomation().addAutomation(b);
          const k = u.getAutomation().getAutomationValueByTarget(b);
          for (const W of p)
            k.addPoint(
              a + Ct(W.ticks, o),
              W.value
      ...
      if (v)
        if (v.length === 1) {
          const b = Math.round(v[0].value * 127 - 64);
          u.setPan(b);
        } else {
          const b = new Q(qn.PAN);
          u.getAutomation().addAutomation(b);
          const k = u.getAutomation().getAutomationValueByTarget(b);
          for (const W of v)
            k.addPoint(a + Ct(W.ticks, o), W.value);
        }
  ...
  getNextTrackId() {
    ...
    if (e.numTracksCreatedByPlugin === n.length)
      n.push(Dt.generateTrackIdInternal());
...
var _h = /* @__PURE__ */ ((t) => (t[t.SelectedTrackIds = 1] = "SelectedTrackIds", t[t.SelectedClipInfos = 2] = "SelectedClipInfos", t[t.TickAtPlayhead = 3] = "TickAtPlayhead", t[t.EditingClipInfo = 4] = "EditingClipInfo", t[t.EditingNoteIds = 5] = "EditingNoteIds", t[t.TickAtPlayheadSnappedToBeat = 6] = "TickAtPlayheadSnappedToBeat", t))(_h || {});
export {
  nn as AudioPlugin,
  kr as AutomationData,
  Q as AutomationTarget,
  qn as AutomationTargetType,
  Mt as AutomationValue,
  Y as Clip,
  re as ClipType,
  Ef as DrumInstrumentType,
  xf as DrumPitch,
  _h as InjectSource,
  _f as MelodicInstrumentType,
  pt as Note,
  rt as Song,
  xh as StructureMarker,
  Ih as StructureType,
  Ee as TempoEvent,
  Oh as TickToSecondStepper,
  Si as TimeSignatureEvent,
  Dt as Track,
  Lt as TrackType,
  Eh as TuneflowPipeline,
  Fs as TuneflowPlugin,
  F as WidgetType,
  kf as areTuneflowIdsEqual,
  Cf as areTuneflowIdsEqualIgnoreVersion,
  If as dbToVolumeValue,
  Qe as decodeAudioPluginTuneflowId,
  yh as gainToDb,
  Fh as gainToVolumeValue,
  Fi as getAudioPluginTuneflowId,
  Sf as getAudioPluginVersionlessTuneflowId,
  Lh as getFileContentFromFileSelector,
  Hh as maybeToRaw,
  Nh as midiNumberToPitch,
  Uh as pitchToHz,
  Ph as pitchToMidiNumber,
  Bh as remapRange,
  Ah as toVersionlessTfId,
  Vh as volumeValueToDb,
  Rh as volumeValueToGain
};
