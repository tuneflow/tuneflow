...
(function(t, e) {
  ...
  function In(c, d, p, S, B, H, et) {
    ...
    return Pa(hi || c, function(Pn, Oe) {
      hi && (Oe = Pn, Pn = c[Oe]), ni(K, Oe, In(Pn, d, p, S, Oe, c, et));
    }), K;
  }
  function go(c) {
    return Ne(c) ? Ua(c) : {};
  ...
  function ri(c, d, p, S) {
    ...
    for (var B = -1, H = d.length; ++B < H; ) {
      var et = d[B], K = S ? S(p[et], c[et], et, p, c) : void 0;
...
class q {
  ...
  static tickToSecondsImpl(e, n, r, i, s, a) {
    ...
    o == -1 && (o = 0);
    const u = n[o], l = a(u), g = e - l.tick, f = q.tempoBPMToTicksPerSecond(
      l.bpm,
      r
    );
    return l.time + g / f;
  ...
  static secondsToTickImpl(e, n, r, i, s, a) {
    ...
    o == -1 && (o = 0);
    const u = r[o], l = a(u), g = e - l.time, f = q.tempoBPMToTicksPerSecond(
      l.bpm,
      n
    );
  ...
  static importMIDI(e, n, r = 0, i = !1, s = -1) {
    const a = new ga.Midi(n), o = r, u = q.DEFAULT_PPQ / a.header.ppq;
    if (i) {
      const g = [];
