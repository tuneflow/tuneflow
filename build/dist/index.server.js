var Gi = "1.13.6", di = typeof self == "object" && self.self === self && self || typeof global == "object" && global.global === global && global || Function("return this")() || {}, sn = Array.prototype, er = Object.prototype, gi = typeof Symbol < "u" ? Symbol.prototype : null, Go = sn.push, Ce = sn.slice, ve = er.toString, Wo = er.hasOwnProperty, Wi = typeof ArrayBuffer < "u", zo = typeof DataView < "u", Ko = Array.isArray, pi = Object.keys, mi = Object.create, vi = Wi && ArrayBuffer.isView, qo = isNaN, Xo = isFinite, zi = !{ toString: null }.propertyIsEnumerable("toString"), ki = [
  "valueOf",
  "isPrototypeOf",
  "toString",
...
var ji = L("Function"), ec = di.document && di.document.childNodes;
...
const rs = Wi ? oc : ts(!1), j = ns("length");
function cc(t) {
...
function uc(t) {
  if (t == null)
    return !0;
  var e = j(t);
  return typeof e == "number" && (Gt(t) || nr(t) || sr(t)) ? e === 0 : j(F(t)) === 0;
}
function ss(t, e) {
...
function as(t, e, n, r) {
  ...
  if (n.push(t), r.push(e), s) {
    ...
    var g = F(t), f;
    if (l = g.length, F(e).length !== l)
      return !1;
    for (; l--; )
      if (f = g[l], !(Pt(e, f) && Ln(t[f], e[f], n, r)))
        return !1;
  }
...
const dc = ir ? ar(fc) : L("Map"), gc = ir ? ar(us) : L("WeakMap"), pc = ir ? ar(hc) : L("Set"), mc = L("WeakSet");
function ae(t) {
...
T.iteratee = dr;
function Q(t, e, n) {
  return T.iteratee !== dr ? T.iteratee(t, e) : ms(t, e, n);
}
function Ic(t, e, n) {
  e = Q(e, n);
...
function Fc(t, e, n) {
  ...
  t.replace(r, function(l, g, f, h, m) {
    return s += t.slice(i, m).replace(Oc, yc), i = m + l.length, g ? s += `'+
...
function ws(t, e, n, r, i) {
  if (!(r instanceof e))
    return t.apply(n, i);
  var s = ds(t.prototype), a = t.apply(s, i);
  return Mt(a) ? a : s;
}
...
function Mc(t, e, n) {
  ...
  var u = function() {
    ...
    !o && n.leading === !1 && (o = g);
    var f = e - (g - o);
    return i = this, s = arguments, f <= 0 || f > e ? (r && (clearTimeout(r), r = null), o = g, a = t.apply(i, s), r || (i = s = null)) : !r && n.trailing !== !1 && (r = setTimeout(u, f)), a;
  };
...
function Gc(t, e, n) {
  var r, i, s, a, o, u = function() {
    var g = Se() - i;
    e > g ? r = setTimeout(u, e - g) : (r = null, n || (a = t.apply(o, s)), r || (s = o = null));
  }, l = J(function(g) {
    return o = this, s = g, i = Se(), r || (r = setTimeout(u, e), n && (a = t.apply(o, s))), a;
  });
  return l.cancel = function() {
...
function se(t, e, n) {
  var r = [];
  return e = Q(e, n), pt(t, function(i, s, a) {
    e(i, s, a) && r.push(i);
  }), r;
}
function jc(t, e, n) {
  return se(t, gr(Q(e)), n);
}
function Ci(t, e, n) {
  e = Q(e, n);
...
function Os(t, e, n) {
  ...
  if (e == null || typeof e == "number" && typeof t[0] != "object" && t != null) {
    ...
    e = Q(e, n), pt(t, function(l, g, f) {
      a = e(l, g, f), (a > i || a === -1 / 0 && r === -1 / 0) && (r = l, i = a);
    });
  return r;
}
function Zc(t, e, n) {
...
function nu(t, e, n) {
  var r = 0;
  return e = Q(e, n), pr(Ht(t, function(i, s, a) {
    return {
      value: i,
      index: r++,
      criteria: e(i, s, a)
...
function an(t, e) {
  return function(n, r, i) {
    var s = e ? [[], []] : {};
    return r = Q(r, i), pt(n, function(a, o) {
      var u = r(a, o, n);
      t(s, a, u);
    }), s;
  };
...
const Fs = J(function(t, e) {
  ...
  var n = e[0], r;
  return G(n) ? (n = gr(n), e.length > 1 && (r = e[1])) : (e = Ht(Wt(e, !1, !1), String), n = function(i, s) {
    return !gt(e, s);
  }), Fs(t, n, r);
});
function Bs(t, e, n) {
...
function Nn(t, e, n) {
  return t == null || t.length < 1 ? e == null || n ? void 0 : [] : e == null || n ? t[0] : Bs(t, t.length - e);
}
function Ge(t, e, n) {
...
function Dn(t, e, n, r) {
  qi(e) || (r = n, n = e, e = !1), n != null && (n = Q(n, r));
...
function Mn(t) {
  for (var e = t && Os(t, j).length || 0, n = Array(e), r = 0; r < e; r++)
    n[r] = pr(t, r);
  return n;
}
const mu = J(Mn);
...
(function(t, e) {
  var n = 200, r = "__lodash_hash_undefined__", i = 9007199254740991, s = "[object Arguments]", a = "[object Array]", o = "[object Boolean]", u = "[object Date]", l = "[object Error]", g = "[object Function]", f = "[object GeneratorFunction]", h = "[object Map]", m = "[object Number]", v = "[object Object]", w = "[object Promise]", k = "[object RegExp]", C = "[object Set]", O = "[object String]", I = "[object Symbol]", b = "[object WeakMap]", y = "[object ArrayBuffer]", ct = "[object DataView]", zt = "[object Float32Array]", Fr = "[object Float64Array]", Br = "[object Int8Array]", Ur = "[object Int16Array]", Vr = "[object Int32Array]", Lr = "[object Uint8Array]", Hr = "[object Uint8ClampedArray]", $r = "[object Uint16Array]", Dr = "[object Uint32Array]", ka = /[\\^$.*+?()[\]{}|]/g, Sa = /\w*$/, wa = /^\[object .+?Constructor\]$/, ba = /^(?:0|[1-9]\d*)$/, P = {};
  P[s] = P[a] = P[y] = P[ct] = P[o] = P[u] = P[zt] = P[Fr] = P[Br] = P[Ur] = P[Vr] = P[h] = P[m] = P[v] = P[k] = P[C] = P[O] = P[I] = P[Lr] = P[Hr] = P[$r] = P[Dr] = !0, P[l] = P[g] = P[b] = !1;
  ...
  function Pa(c, d) {
    for (var p = -1, S = c ? c.length : 0; ++p < S && d(c[p], p, c) !== !1; )
      ;
    return c;
  }
  function Aa(c, d) {
    for (var p = -1, S = d.length, U = c.length; ++p < S; )
      c[U + p] = d[p];
    return c;
  }
  function Wr(c, d, p, S) {
  ...
  function qa(c) {
    ...
    return mt.call(d, c) ? d[c] : void 0;
  }
  function Xa(c) {
    var d = this.__data__;
    return ue ? d[c] !== void 0 : mt.call(d, c);
  }
  function Ja(c, d) {
    var p = this.__data__;
    return p[c] = ue && d === void 0 ? r : d, this;
  }
  ...
  function Qa(c) {
    var d = this.__data__, p = Ae(d, c);
    if (p < 0)
      return !1;
    var S = d.length - 1;
    return p == S ? d.pop() : Va.call(d, p, 1), !0;
  }
  function Ya(c) {
    var d = this.__data__, p = Ae(d, c);
  ...
  function to(c, d) {
    ...
    return S < 0 ? p.push([c, d]) : p[S][1] = d, this;
  }
  dt.prototype.clear = ja, dt.prototype.delete = Qa, dt.prototype.get = Ya, dt.prototype.has = Za, dt.prototype.set = to;
  function Kt(c) {
    var d = -1, p = c ? c.length : 0;
    for (this.clear(); ++d < p; ) {
      var S = c[d];
  ...
  function lo(c, d) {
    ...
    if (p instanceof dt) {
      var S = p.__data__;
      if (!ce || S.length < n - 1)
        return S.push([c, d]), this;
      p = this.__data__ = new Kt(S);
    }
    return p.set(c, d), this;
  }
  qt.prototype.clear = ao, qt.prototype.delete = oo, qt.prototype.get = co, qt.prototype.has = uo, qt.prototype.set = lo;
  function fo(c, d) {
    var p = En(c) || Uo(c) ? xa(c.length, String) : [], S = p.length, U = !!S;
    for (var H in c)
      (d || mt.call(c, H)) && !(U && (H == "length" || yo(H, S))) && p.push(H);
    return p;
  }
  function ni(c, d, p) {
    var S = c[d];
    (!(mt.call(c, d) && ai(S, p)) || p === void 0 && !(d in c)) && (c[d] = p);
  }
  function Ae(c, d) {
  ...
  function ko(c) {
    ...
    for (var p in Object(c))
      mt.call(c, p) && p != "constructor" && d.push(p);
    return d;
  }
  function So(c, d) {
    if (d)
  ...
  function Tn(c) {
    ...
    return new Yr(d).set(new Yr(c)), d;
  }
  function wo(c, d) {
    var p = d ? Tn(c.buffer) : c.buffer;
    return new c.constructor(p, c.byteOffset, c.byteLength);
  }
  function bo(c, d, p) {
    var S = d ? p(Kr(c), !0) : Kr(c);
    return Wr(S, Ea, new c.constructor());
  }
  function Co(c) {
    var d = new c.constructor(c.source, Sa.exec(c));
    return d.lastIndex = c.lastIndex, d;
  }
  function Io(c, d, p) {
    var S = d ? p(qr(c), !0) : qr(c);
  ...
  function xe(c, d) {
    var p = c.__data__;
    return Ro(d) ? p[typeof d == "string" ? "string" : "hash"] : p.map;
  }
  function Xt(c, d) {
    var p = Na(c, d);
  ...
  (Sn && xt(new Sn(new ArrayBuffer(1))) != ct || ce && xt(new ce()) != h || wn && xt(wn.resolve()) != w || bn && xt(new bn()) != C || Cn && xt(new Cn()) != b) && (xt = function(c) {
    var d = Pe.call(c), p = d == v ? c.constructor : void 0, S = p ? Nt(p) : void 0;
    if (S)
      switch (S) {
        case $a:
          return ct;
  ...
  function xo(c) {
    var d = c.length, p = c.constructor(d);
    return d && typeof c[0] == "string" && mt.call(c, "index") && (p.index = c.index, p.input = c.input), p;
  }
  function No(c) {
  ...
  function yo(c, d) {
    return d = d ?? i, !!d && (typeof c == "number" || ba.test(c)) && c > -1 && c % 1 == 0 && c < d;
  }
  function Ro(c) {
    var d = typeof c;
  ...
  function si(c) {
    var d = c && c.constructor, p = typeof d == "function" && d.prototype || _e;
    return c === p;
  }
  function Nt(c) {
    if (c != null) {
  ...
  function Uo(c) {
    return Vo(c) && mt.call(c, "callee") && (!Ua.call(c, "callee") || Pe.call(c) == s);
  }
...
const Sr = () => {
}, yu = () => !1, Ru = /^on[^a-z]/, Fu = (t) => Ru.test(t), at = Object.assign, Bu = (t, e) => {
  const n = t.indexOf(e);
  n > -1 && t.splice(n, 1);
}, Uu = Object.prototype.hasOwnProperty, R = (t, e) => Uu.call(t, e), N = Array.isArray, te = (t) => cn(t) === "[object Map]", Vu = (t) => cn(t) === "[object Set]", W = (t) => typeof t == "function", ot = (t) => typeof t == "string", wr = (t) => typeof t == "symbol", X = (t) => t !== null && typeof t == "object", Lu = (t) => X(t) && W(t.then) && W(t.catch), Hu = Object.prototype.toString, cn = (t) => Hu.call(t), Ls = (t) => cn(t).slice(8, -1), $u = (t) => cn(t) === "[object Object]", br = (t) => ot(t) && t !== "NaN" && t[0] !== "-" && "" + parseInt(t, 10) === t, Du = (t) => {
  const e = /* @__PURE__ */ Object.create(null);
  return (n) => e[n] || (e[n] = t(n));
}, Ih = Du((t) => t.charAt(0).toUpperCase() + t.slice(1)), Je = (t, e) => !Object.is(t, e), Mu = (t, e, n) => {
...
class Ju {
  ...
  run() {
    ...
    try {
      return this.parent = q, q = this, Bt = !0, Et = 1 << ++he, he <= qn ? qu(this) : Ai(this), this.fn();
    } finally {
      he <= qn && Xu(this), Et = 1 << --he, q = this.parent, Bt = n, this.parent = void 0, this.deferStop && this.stop();
    }
  }
  stop() {
    q === this ? this.deferStop = !0 : this.active && (Ai(this), this.onStop && this.onStop(), this.active = !1);
  }
}
function Ai(t) {
  const { deps: e } = t;
...
function ju(t, e) {
  let n = !1;
  he <= qn ? $s(t) || (t.n |= Et, n = !Hs(t)) : n = !t.has(q), n && (t.add(q), q.deps.push(t), process.env.NODE_ENV !== "production" && q.onTrack && q.onTrack(Object.assign({ effect: q }, e)));
}
...
function xi(t, e) {
  (t !== q || t.allowRecurse) && (process.env.NODE_ENV !== "production" && t.onTrigger && t.onTrigger(at({ effect: t }, e)), t.scheduler ? t.scheduler() : t.run());
}
...
const [ll, fl, hl, dl] = /* @__PURE__ */ ul();
function Tr(t, e) {
  const n = e ? t ? dl : hl : t ? fl : ll;
...
function Ut(t) {
  return $t(t) ? Ut(t.__v_raw) : !!(t && t.__v_isReactive);
}
function $t(t) {
...
const _r = (t) => X(t) ? js(t) : t, Pr = (t) => X(t) ? Qs(t) : t;
function M(t) {
...
const we = (t) => t.id == null ? 1 / 0 : t.id, Bl = (t, e) => {
  const n = we(t) - we(e);
  if (n === 0) {
    if (t.pre && !e.pre)
      return -1;
...
function ia(t) {
  Qn = !1, Qe = !0, process.env.NODE_ENV !== "production" && (t = t || /* @__PURE__ */ new Map()), st.sort(Bl);
...
function Ll(t, e) {
  ...
  if (!n)
    return;
  e = ge(e), Bi(n.initialDef, e);
  const r = [...n.instances];
  for (const i of r) {
    const s = ge(i.type);
    fe.has(s) || (s !== n.initialDef && Bi(s, e), fe.add(s)), i.appContext.optionsCache.delete(i.type), i.ceReload ? (fe.add(s), i.ceReload(e.styles), fe.delete(s)) : i.parent ? xr(i.parent.update) : i.appContext.reload ? i.appContext.reload() : typeof window < "u" && window.location.reload();
  }
  ra(() => {
    for (const i of r)
      fe.delete(ge(i.type));
...
function Ml(t, e, { immediate: n, deep: r, flush: i, onTrack: s, onTrigger: a } = lt) {
  ...
  let l, g = !1, f = !1;
  if (M(t) ? (l = () => t.value, g = Jn(t)) : Ut(t) ? (l = () => t, r = !0) : N(t) ? (f = !0, g = t.some((I) => Ut(I) || Jn(I)), l = () => t.map((I) => {
    if (M(I))
      return I.value;
    if (Ut(I))
      return Yt(I);
  ...
  const w = () => {
    if (!!C.active)
      if (e) {
        const I = C.run();
        (r || g || (f ? I.some((b, y) => Je(b, v[y])) : Je(I, v))) && (h && h(), jn(e, u, 3, [
          I,
  ...
  return process.env.NODE_ENV !== "production" && (C.onTrack = s, C.onTrigger = a), e ? n ? w() : v = C.run() : i === "post" ? Li(C.run.bind(C), u && u.suspense) : C.run(), () => {
    C.stop(), u && u.scope && Bu(u.scope.effects, C);
  };
}
function Gl(t, e, n) {
...
const zl = Symbol(), Yn = (t) => t ? hf(t) ? df(t) || t.proxy : Yn(t.parent) : null, pe = /* @__PURE__ */ at(/* @__PURE__ */ Object.create(null), {
  $: (t) => t,
  $el: (t) => t.vnode.el,
  $data: (t) => t.data,
...
function Jl(t) {
  ...
  let u;
  return o ? u = o : !i.length && !n && !r ? u = e : (u = {}, i.length && i.forEach((l) => Ze(u, l, a, !0)), Ze(u, e, a)), X(e) && s.set(e, u), u;
}
...
function ua(t, e = null, n = null, r = 0, i = null, s = !1) {
  ...
  if (da(t) && (t = t.__vccOpts), e) {
    ...
    o && !ot(o) && (e.class = kr(o)), X(u) && (je(u) && !N(u) && (u = at({}, u)), e.style = vr(u));
  }
  const a = ot(t) ? 1 : $l(t) ? 128 : tf(t) ? 64 : X(t) ? 4 : W(t) ? 2 : 0;
...
const gf = /(?:^|[-_])(\w)/g, pf = (t) => t.replace(gf, (e) => e.toUpperCase()).replace(/[-_]/g, "");
function fa(t, e = !0) {
...
function mf() {
  ...
  function l(f, h, m) {
    const v = f[m];
    if (N(v) && v.includes(h) || X(v) && h in v || f.extends && l(f.extends, h, m) || f.mixins && f.mixins.some((w) => l(w, h, m)))
      return !0;
  }
  function g(f) {
...
const Bh = ["wav", "mp3", "aiff", "flac", "ogg"], Zn = 480;
class ln {
  name;
  manufacturerName;
  pluginFormatName;
...
var de = /* @__PURE__ */ ((t) => (t[t.MIDI_CLIP = 1] = "MIDI_CLIP", t[t.AUDIO_CLIP = 2] = "AUDIO_CLIP", t))(de || {});
class A {
  song;
  track;
  id;
  ...
  timeStretchAudioClipImpl(e, n, r) {
    ...
    const g = this.song.tickToSeconds(i.startTick), f = this.song.tickToSeconds(r), h = (f - g) * u, m = f - h, v = this.song.secondsToTick(m);
...
class re {
  ...
  movePoints(e, n, r, i = !0) {
    ...
    for (let l = 0; l < this.points.length; l += 1) {
      ...
      !s.has(g.id) || (u.push(g), a === void 0 && (a = l), o = l);
    }
    if (!(a === void 0 || o === void 0)) {
      if (i) {
        if (n < 0) {
          ...
          const l = this.points[o].tick + n, g = x.lt(
            this.points,
            { tick: l },
            (f, h) => f.tick - h.tick
          );
...
class nt {
  ...
  constructor({
    ...
    this.song = n, this.type = e, s ? this.insturment = s : e === 1 && (this.insturment = new me({
      program: 0,
      isDrum: !1
    })), e === 4 && (this.auxTrackData = new Pf(), this.auxTrackData.setInputBusRank(1)), this.clips = [...i], this.suggestedInstruments = [...a], this.uuid = r, this.volume = o, this.solo = u, this.muted = l, this.rank = g, this.pan = f, this.automation = new Or();
  }
  getType() {
    return this.type;
  }
...
var _f = /* @__PURE__ */ ((t) => (t[t.Undefined = 0] = "Undefined", t[t.PreFader = 1] = "PreFader", t[t.PostFader = 2] = "PostFader", t))(_f || {});
class nn {
  outputBusRank;
  gainLevel;
  position;
      ...
      if (o === 255) {
        ...
        switch (u) {
          ...
          case 84:
            ...
            var g = e.readUInt8(), f = { 0: 24, 32: 25, 64: 29, 96: 30 };
            return a.frameRate = f[g & 96], a.hour = g & 31, a.min = e.readUInt8(), a.sec = e.readUInt8(), a.frame = e.readUInt8(), a.subFrame = e.readUInt8(), a;
          case 88:
...
function Vf(t, e, n) {
  ...
  for (i = 0; i < s; i++)
    (n.running === !1 || !n.running && !e[i].running) && (a = null), a = Lf(r, e[i], a, n.useByte9ForNoteOff);
  ...
  var r = function() {
    ...
    return i.prototype.update = function() {
      ...
      this.tempos.sort(function(u, l) {
        ...
        var g = l > 0 ? s.tempos[l - 1].bpm : s.tempos[0].bpm, f = u.ticks / s.ppq - o, h = 60 / g * f;
        u.time = h + a, a = u.time, o += f;
      }), this.timeSignatures.sort(function(u, l) {
        return u.ticks - l.ticks;
      }), this.timeSignatures.forEach(function(u, l) {
        var g = l > 0 ? s.timeSignatures[l - 1] : s.timeSignatures[0], f = (u.ticks - g.ticks) / s.ppq, h = f / g.timeSignature[0] / (g.timeSignature[1] / 4);
      ...
      if (a !== -1) {
        var o = this.tempos[a], u = o.time, l = s - u, g = l / (60 / o.bpm);
...
hn.createControlChanges = Df;
var dn = {};
Object.defineProperty(dn, "__esModule", { value: !0 });
dn.PitchBend = void 0;
var Bn = /* @__PURE__ */ new WeakMap(), Mf = function() {
  function t(e, n) {
    Bn.set(this, n), this.ticks = e.absoluteTime, this.value = e.value;
  }
...
var De = Tt, Di = /* @__PURE__ */ new WeakMap(), Gf = function() {
  function t(e, n) {
...
var Kf = function() {
...
}(), jt = /* @__PURE__ */ new WeakMap(), qf = function() {
  function t(e, n, r) {
  ...
  return Object.defineProperty(t.prototype, "name", {
    ...
    set: function(e) {
      this.midi = 12 * (this.octave + 1) + zf(e);
    },
    enumerable: !1,
    configurable: !0
...
be.Track = void 0;
var Un = Dt, Xf = Rr, Jf = hn, jf = dn, Mi = gn, Qf = pn, Me = /* @__PURE__ */ new WeakMap(), Yf = function() {
  function t(e, n) {
    var r = this;
  ...
  return t.prototype.addNote = function(e) {
    var n = Me.get(this), r = new Qf.Note({
      midi: 0,
      ticks: 0,
      velocity: 1
    }, {
    ...
    return Object.assign(r, e), (0, Un.insert)(this.notes, r, "ticks"), this;
  }, t.prototype.addCC = function(e) {
    var n = Me.get(this), r = new Xf.ControlChange({
      controllerType: e.number
    }, n);
    return delete e.number, Object.assign(r, e), Array.isArray(this.controlChanges[r.number]) || (this.controlChanges[r.number] = []), (0, Un.insert)(this.controlChanges[r.number], r, "ticks"), this;
  }, t.prototype.addPitchBend = function(e) {
    var n = Me.get(this), r = new jf.PitchBend({}, n);
    return Object.assign(r, e), (0, Un.insert)(this.pitchBends, r, "ticks"), this;
  }, Object.defineProperty(t.prototype, "duration", {
    get: function() {
...
const th = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  flatten: Zf
}, Symbol.toStringTag, { value: "Module" })), eh = /* @__PURE__ */ bu(th);
...
function ah(t) {
  return (0, ih.flatten)(t.notes.map(function(e) {
    return sh(e, t.channel);
  }));
}
function oh(t, e) {
  return {
...
function ph(t) {
  var e = rh.keySignatureKeys.indexOf(t.key);
  return {
    absoluteTime: t.ticks,
    deltaTime: 0,
    key: e + 7,
...
function vh(t) {
  ...
  }), new Uint8Array((0, nh.writeMidi)(e));
}
mn.encode = vh;
(function(t) {
...
var kh = /* @__PURE__ */ ((t) => (t[t.UNKNOWN = 0] = "UNKNOWN", t[t.INTRO = 1] = "INTRO", t[t.VERSE = 2] = "VERSE", t[t.CHORUS = 3] = "CHORUS", t[t.BRIDGE = 4] = "BRIDGE", t[t.OUTRO = 5] = "OUTRO", t[t.PRE_CHORUS = 6] = "PRE_CHORUS", t[t.POST_CHORUS = 7] = "POST_CHORUS", t[t.FILL = 8] = "FILL", t[t.CUSTOM = 9] = "CUSTOM", t))(kh || {});
class Sh {
  tick;
  type;
  customName;
...
class tt {
  ...
  lyrics;
  constructor() {
    this.tracks = [], this.PPQ = 0, this.tempos = [], this.timeSignatures = [], this.structures = [], this.lyrics = new wh({ song: this });
  }
  getBusByRank(e) {
  ...
  static getBarBeatsImpl(e, n, r, i) {
    ...
    for (; o <= e; ) {
      ...
      a.push({
        ...
        beat: g,
        tick: o,
        numerator: g === 1 ? f.numerator : void 0,
        denominator: g === 1 ? f.denominator : void 0,
        ticksPerBeat: g === 1 ? n * 4 / f.denominator : void 0
      }), g >= f.numerator ? (g = 1, l += 1) : g += 1, o += n * 4 / f.denominator;
    }
    return a;
  }
  getTempoChanges() {
  ...
  static importMIDI(e, n, r = 0, i = !1, s = -1) {
    ...
    if (i) {
      ...
      g.length > 0 && (o > 0 && g[0].setTicks(0), e.overwriteTimeSignatures(g));
      const f = [];
...
export {
  ...
  nn as TrackSend,
  _f as TrackSendPosition,
  Qt as TrackType,
  yt as TuneflowPipeline,
  Gn as TuneflowPlugin,
  Vh as TuneflowPluginCategory,
  V as WidgetType,
  ...
  Ah as gainToDb,
  Oh as gainToVolumeValue,
  $i as getAudioPluginTuneflowId,
  bf as getAudioPluginVersionlessTuneflowId,
  Uh as getFileContentFromFileSelector,
  Fh as maybeToRaw,
  Th as midiNumberToPitch,
  Rh as pitchToHz,
  Eh as pitchToMidiNumber,
  yh as remapRange,
  _h as toVersionlessTfId,
  xh as volumeValueToDb,
  Nh as volumeValueToGain
};
