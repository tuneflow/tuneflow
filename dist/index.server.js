var $i = '1.13.4',
  ...
  rn = Array.prototype,
  Xn = Object.prototype,
  ui = typeof Symbol < 'u' ? Symbol.prototype : null,
  Ha = rn.push,
  Te = rn.slice,
  ge = Xn.toString,
  qa = Xn.hasOwnProperty,
  Di = typeof ArrayBuffer < 'u',
  Ka = typeof DataView < 'u',
  za = Array.isArray,
  li = Object.keys,
  fi = Object.create,
  hi = Di && ArrayBuffer.isView,
  Ga = isNaN,
  Ja = isFinite,
  Li = !{ toString: null }.propertyIsEnumerable('toString'),
  pi = [
    'valueOf',
    'isPrototypeOf',
    'toString',
...
function qi(t) {
  return t === !0 || t === !1 || ge.call(t) === '[object Boolean]';
}
function Ya(t) {
...
const Qn = R('String'),
  ...
  Gi = R('ArrayBuffer');
var Ji = R('Function'),
  tc = ci.document && ci.document.childNodes;
typeof /./ != 'function' &&
...
const D = Ji,
  Wi = R('Object');
var ji = Ka && Wi(new DataView(new ArrayBuffer(8))),
  Zn = typeof Map < 'u' && Wi(/* @__PURE__ */ new Map()),
  ec = R('DataView');
function nc(t) {
...
function N(t) {
  ...
  if (li) return li(t);
  var e = [];
  for (var n in t) bt(t, n) && e.push(n);
  return Li && es(t, e), e;
}
function cc(t) {
  if (t == null) return !0;
  var e = J(t);
  return typeof e == 'number' && ($t(t) || Qn(t) || tr(t)) ? e === 0 : J(N(t)) === 0;
}
function ns(t, e) {
  var n = N(e),
    r = n.length;
...
function rs(t, e, n, r) {
  ...
  if (!s) {
    ...
    if (
      a !== u &&
      !(D(a) && a instanceof a && D(u) && u instanceof u) &&
      'constructor' in t &&
      'constructor' in e
    )
      return !1;
  ...
  if ((n.push(t), r.push(e), s)) {
    ...
    for (; l--; ) if (!Rn(t[l], e[l], n, r)) return !1;
  } else {
    var g = N(t),
      p;
    if (((l = g.length), N(e).length !== l)) return !1;
    for (; l--; ) if (((p = g[l]), !(bt(e, p) && Rn(t[p], e[p], n, r)))) return !1;
  }
...
function er(t) {
  ...
  return function (n) {
    ...
    var r = be(n);
    if (J(r)) return !1;
    for (var i = 0; i < e; i++) if (!D(n[t[i]])) return !1;
    return t !== os || !D(n[nr]);
  };
}
var nr = 'forEach',
  ...
  lc = rr.concat(nr, ss),
  os = rr.concat(ss),
  fc = ['add'].concat(rr, nr, is);
const hc = Zn ? er(lc) : R('Map'),
  pc = Zn ? er(os) : R('WeakMap'),
  dc = Zn ? er(fc) : R('Set'),
  gc = R('WeakSet');
function re(t) {
  for (var e = N(t), n = e.length, r = Array(n), i = 0; i < n; i++) r[i] = t[e[i]];
  return r;
}
function mc(t) {
  for (var e = N(t), n = e.length, r = Array(n), i = 0; i < n; i++) r[i] = [e[i], t[e[i]]];
  return r;
}
function as(t) {
  for (var e = {}, n = N(t), r = 0, i = n.length; r < i; r++) e[t[n[r]]] = n[r];
  return e;
}
function Fn(t) {
  var e = [];
...
function ps(t, e, n) {
  return t == null ? or : D(t) ? ke(t, e, n) : Bt(t) && !$t(t) ? me(t) : ar(t);
}
function cr(t, e) {
  return ps(t, e, 1 / 0);
}
...
function Mc(t, e, n) {
  ...
  var r = RegExp(
      [(e.escape || xn).source, (e.interpolate || xn).source, (e.evaluate || xn).source].join('|') +
        '|$',
      'g',
    ),
    i = 0,
    s = "__p+='";
  t.replace(r, function (l, g, p, h, m) {
    return (
      (s += t.slice(i, m).replace(Pc, Oc)),
      (i = m + l.length),
      g
        ? (s +=
            `'+
...
`);
  var o = e.variable;
  if (o) {
    if (!Ac.test(o)) throw new Error('variable is not a bare identifier: ' + o);
  } else
    (s =
      `with(obj||{}){
` +
...
function Is(t, e, n, r, i) {
  ...
  var s = ls(t.prototype),
    o = t.apply(s, i);
  return Bt(o) ? o : s;
}
var ie = G(function (t, e) {
  var n = ie.placeholder,
    r = function () {
...
function Dt(t, e, n, r) {
  ...
  for (var i = r.length, s = 0, o = J(t); s < o; s++) {
    var a = t[s];
    if (Q(a) && ($t(a) || tr(a)))
      if (e > 1) Dt(a, e - 1, n, r), (i = r.length);
...
function Lc(t, e, n) {
  ...
  n || (n = {});
  var u = function () {
      (a = n.leading === !1 ? 0 : Ie()), (r = null), (o = t.apply(i, s)), r || (i = s = null);
    },
    l = function () {
      var g = Ie();
      !a && n.leading === !1 && (a = g);
      ...
      return (
        ...
        (s = arguments),
        p <= 0 || p > e
          ? (r && (clearTimeout(r), (r = null)), (a = g), (o = t.apply(i, s)), r || (i = s = null))
...
function Hc(t, e, n) {
  var r,
    ...
    u = function () {
      ...
      e > g
        ? (r = setTimeout(u, e - g))
        : ((r = null), n || (o = t.apply(a, s)), r || (s = a = null));
    },
    l = G(function (g) {
      return (
        (a = this), (s = g), (i = Ie()), r || ((r = setTimeout(u, e)), n && (o = t.apply(a, s))), o
      );
    });
  return (
    (l.cancel = function () {
...
function bs(t, e, n) {
  e = W(e, n);
  for (var r = N(t), i, s = 0, o = r.length; s < o; s++) if (((i = r[s]), e(t[i], i, t))) return i;
}
function ws(t) {
...
function _s(t, e, n) {
  return function (r, i, s) {
    ...
    if (i !== i) return (s = e(Te.call(r, o, a), Yi)), s >= 0 ? s + o : -1;
...
function ht(t, e, n) {
  e = ke(e, n);
  var r, i;
  if (Q(t)) for (r = 0, i = t.length; r < i; r++) e(t[r], r, t);
  else {
    var s = N(t);
...
function Rt(t, e, n) {
  e = W(e, n);
  for (var r = !Q(t) && N(t), i = (r || t).length, s = Array(i), o = 0; o < i; o++) {
    var a = r ? r[o] : o;
    s[o] = e(t[a], a, t);
  }
  return s;
...
function Ii(t, e, n) {
  e = W(e, n);
  for (var r = !Q(t) && N(t), i = (r || t).length, s = 0; s < i; s++) {
    var o = r ? r[s] : s;
...
function ft(t, e, n, r) {
  return Q(t) || (t = re(t)), (typeof n != 'number' || r) && (n = 0), Cs(t, e, n) >= 0;
}
const Yc = G(function (t, e, n) {
  var r, i;
  return (
    D(e) ? (i = e) : ((e = we(e)), (r = e.slice(0, -1)), (e = e[e.length - 1])),
    Rt(t, function (s) {
      var o = i;
      if (!o) {
        if ((r && r.length && (s = sr(s, r)), s == null)) return;
        o = s[e];
      }
...
function Es(t, e, n) {
  ...
  if (e == null || (typeof e == 'number' && typeof t[0] != 'object' && t != null)) {
    t = Q(t) ? t : re(t);
    for (var a = 0, u = t.length; a < u; a++) (s = t[a]), s != null && s > r && (r = s);
  } else
    (e = W(e, n)),
      ht(t, function (l, g, p) {
        (o = e(l, g, p)), (o > i || (o === -1 / 0 && r === -1 / 0)) && ((r = l), (i = o));
      });
  return r;
}
function Qc(t, e, n) {
...
var Zc = /[^\ud800-\udfff]|[\ud800-\udbff][\udc00-\udfff]|[\ud800-\udfff]/g;
function Ns(t) {
  return t ? ($t(t) ? Te.call(t) : Qn(t) ? t.match(Zc) : Q(t) ? Rt(t, or) : re(t)) : [];
}
function Ps(t, e, n) {
  if (e == null || n) return Q(t) || (t = re(t)), t[Un(t.length - 1)];
  var r = Ns(t),
    i = J(r);
...
function ou(t) {
  return t == null ? 0 : Q(t) ? t.length : N(t).length;
}
function au(t, e, n) {
  return e in n;
}
const Os = G(function (t, e) {
    ...
    if (t == null) return n;
    D(r)
      ? (e.length > 1 && (r = ke(r, e[1])), (e = be(t)))
      : ((r = au), (e = Dt(e, !1, !1)), (t = Object(t)));
  ...
  cu = G(function (t, e) {
    ...
    return (
      D(n)
        ? ((n = ur(n)), e.length > 1 && (r = e[1]))
        : ((e = Rt(Dt(e, !1, !1), String)),
          (n = function (i, s) {
            return !ft(e, s);
          })),
      Os(t, n, r)
...
function As(t, e, n) {
  return Te.call(t, 0, Math.max(0, t.length - (e == null || n ? 1 : e)));
}
function Nn(t, e, n) {
...
function $n(t) {
  for (var e = (t && Es(t, J).length) || 0, n = Array(e), r = 0; r < e; r++) n[r] = lr(t, r);
  return n;
}
const gu = G($n);
function mu(t, e) {
...
function vu(t, e) {
  ...
  for (var n = [], r = 0, i = t.length; r < i; ) n.push(Te.call(t, r, (r += e)));
  return n;
}
function fr(t, e) {
...
class Rs {
  ...
  hasAllParamsSet() {
    for (const e of N(this.params())) if (!this.isParamProvided(e)) return !1;
    return !0;
  }
  isParamProvided(e) {
    if (this.params()[e].optional) return !0;
    ...
    switch (i) {
      ...
      case B.InstrumentSelector:
        return (
          n.program !== void 0 && n.program !== null && n.isDrum !== void 0 && n.isDrum !== null
        );
...
class fh {
  ...
  addAsOrReplaceActivePlugin(e) {
    ...
    return (
      this.activePluginIndex <= -1
        ? (n = 0)
        : this.plugins[this.activePluginIndex].isRollbackable
        ? (n = this.activePluginIndex + 1)
        : (n = this.activePluginIndex),
      this.plugins.length > 0 && this.plugins.splice(n, this.plugins.length - n),
      this.addPluginAt(e, n),
      this.getPluginIndexByPluginInstanceId(e.instanceId)
    );
  }
  getPlugins() {
    return this.plugins;
  ...
  resetCache() {
    for (const e of this.plugins) delete e.songCacheInternal;
  }
  setOriginalSong(e) {
    this.originalSong = e;
  }
  ...
  async run(e = 0) {
    if (!this.originalSong) return (this.threwErrorInLastRun = !0), null;
    (e = Math.max(0, e)), this.setActivePluginIndex(e), (this.threwErrorInLastRun = !1);
    const n = this.getIndexOfLatestPluginWithCacheBeforeIndex(e),
      r = await this.cloneCachedSongAtPluginIndex(n);
    for (let i = e; i < this.plugins.length; i += 1) delete this.plugins[i].songCacheInternal;
    for (let i = 0; i < this.plugins.length; i += 1) this.plugins[i].isRollbackable = i <= n;
    for (let i = n >= 0 ? n + 1 : 0; i < this.plugins.length; i += 1) {
      const s = this.plugins[i];
      if (!s.enabledInternal || !s.hasAllParamsSet()) return r;
      r.setPluginContextInternal(s);
      try {
        (s.isExecuting = !0),
          s.setProgress(null),
          await s.run(r, s.getParamsInternal(), this.readApisInternal),
          r.clearPluginContextInternal(),
          (s.isExecuting = !1);
      } catch {
        ...
        return a >= 0
          ? await this.cloneSong(this.plugins[a].songCacheInternal)
          : await this.cloneSong(this.originalSong);
      }
  ...
  async cloneCachedSongAtPluginIndex(e) {
    if (e >= 0) return await this.cloneSong(this.plugins[e].songCacheInternal);
    if (!this.originalSong) throw new Error('Original song is not avaiable to clone.');
    return await this.cloneSong(this.originalSong);
  }
  reset() {
    this.plugins.splice(0, this.plugins.length),
      (this.originalSong = void 0),
      (this.activePluginIndex = -1),
      (this.threwErrorInLastRun = !1);
  }
  ...
  getIndexOfLatestPluginWithCacheBeforeIndex(e) {
    for (let n = e - 1; n >= 0; n -= 1) if (this.getPluginCache(this.plugins[n])) return n;
    return -1;
  }
...
function ae(t, e, n, r, i, s) {
  return typeof n == 'function'
    ? s(t, e, n, r === void 0 ? 0 : r | 0, i === void 0 ? t.length - 1 : i | 0)
    : s(t, e, void 0, n === void 0 ? 0 : n | 0, r === void 0 ? t.length - 1 : r | 0);
}
var V = {
...
(function (t, e) {
  ...
  (C[s] =
    ...
    C[Fr] =
      !0),
    (C[l] = C[g] = C[b] = !1);
  var wo = typeof at == 'object' && at && at.Object === Object && at,
    ko = typeof self == 'object' && self && self.Object === Object && self,
    ct = wo || ko || Function('return this')(),
    Ur = e && !e.nodeType && e,
    Br = Ur && !0 && t && !t.nodeType && t,
    So = Br && Br.exports === Ur;
  function _o(c, f) {
  ...
  function Eo(c, f) {
    for (var d = -1, v = f.length, A = c.length; ++d < v; ) c[A + d] = f[d];
    return c;
  }
  function $r(c, f, d, v) {
    var A = -1,
      F = c ? c.length : 0;
    for (v && F && (d = c[++A]); ++A < F; ) d = f(d, c[A], A, c);
    return d;
  }
  function No(c, f) {
    for (var d = -1, v = Array(c); ++d < c; ) v[d] = f(d);
    return v;
  }
  function Po(c, f) {
  ...
  var Oo = Array.prototype,
    ...
    zr = So ? ct.Buffer : void 0,
    Gr = ct.Symbol,
    Jr = ct.Uint8Array,
    Vo = mn(Object.getPrototypeOf, Object),
    Ro = Object.create,
    Fo = Se.propertyIsEnumerable,
    Uo = Oo.splice,
    Wr = Object.getOwnPropertySymbols,
    Bo = zr ? zr.isBuffer : void 0,
    $o = mn(Object.keys, Object),
    vn = Kt(ct, 'DataView'),
    se = Kt(ct, 'Map'),
    yn = Kt(ct, 'Promise'),
    Tn = Kt(ct, 'Set'),
    ...
    qo = St(Tn),
    Ko = St(bn),
    jr = Gr ? Gr.prototype : void 0,
    Yr = jr ? jr.valueOf : void 0;
  function wt(c) {
    var f = -1,
      d = c ? c.length : 0;
    for (this.clear(); ++f < d; ) {
  ...
  (wt.prototype.clear = zo),
    (wt.prototype.delete = Go),
    (wt.prototype.get = Jo),
    (wt.prototype.has = Wo),
    (wt.prototype.set = jo);
  function ut(c) {
  ...
  (ut.prototype.clear = Yo),
    (ut.prototype.delete = Xo),
    (ut.prototype.get = Qo),
    (ut.prototype.has = Zo),
    (ut.prototype.set = ta);
  function Ht(c) {
  ...
  function sa(c, f) {
    return xe(this, c).set(c, f), this;
  }
  (Ht.prototype.clear = ea),
    (Ht.prototype.delete = na),
    (Ht.prototype.get = ra),
    (Ht.prototype.has = ia),
    (Ht.prototype.set = sa);
  function qt(c) {
  ...
  function la(c, f) {
    ...
    if (d instanceof ut) {
      var v = d.__data__;
      if (!se || v.length < n - 1) return v.push([c, f]), this;
  ...
  (qt.prototype.clear = oa),
    ...
    (qt.prototype.set = la);
  function fa(c, f) {
    var d = Sn(c) || Ra(c) ? No(c.length, String) : [],
      v = d.length,
      A = !!v;
    for (var F in c) (f || pt.call(c, F)) && !(A && (F == 'length' || Oa(F, v))) && d.push(F);
    return d;
  }
  function Xr(c, f, d) {
    var v = c[f];
  ...
  function Ce(c, f) {
    for (var d = c.length; d--; ) if (ei(c[d][0], f)) return d;
    return -1;
  }
  function ha(c, f) {
    return c && Qr(f, _n(f), c);
  }
  function wn(c, f, d, v, A, F, Z) {
    var q;
    if ((v && (q = F ? v(c, A, F, Z) : v(c)), q !== void 0)) return q;
    if (!Ee(c)) return c;
    var ii = Sn(c);
    if (ii) {
      if (((q = Ea(c)), !f)) return _a(c, q);
    } else {
      var zt = kt(c),
        si = zt == g || zt == p;
      if (Ua(c)) return va(c, f);
      if (zt == I || zt == s || (si && !F)) {
        if (Dr(c)) return F ? c : {};
        if (((q = Na(si ? {} : c)), !f)) return Ca(c, ha(q, c));
      } else {
        if (!C[zt]) return F ? c : {};
        q = Pa(c, zt, wn, f);
      }
    ...
    var oi = Z.get(c);
    if (oi) return oi;
    if ((Z.set(c, q), !ii)) var ai = d ? xa(c) : _n(c);
    return (
      xo(ai || c, function (Cn, Ne) {
        ai && ((Ne = Cn), (Cn = c[Ne])), Xr(q, Ne, wn(Cn, f, d, v, Ne, c, Z));
      }),
      q
    );
  }
  ...
  function Ia(c) {
    if (!ti(c)) return $o(c);
    var f = [];
    for (var d in Object(c)) pt.call(c, d) && d != 'constructor' && f.push(d);
    return f;
  }
  function va(c, f) {
    if (f) return c.slice();
  ...
  function Qr(c, f, d, v) {
    ...
    for (var A = -1, F = f.length; ++A < F; ) {
      var Z = f[A],
        q = v ? v(d[Z], c[Z], Z, d, c) : void 0;
      Xr(d, Z, q === void 0 ? c[Z] : q);
    }
    return d;
  }
  function Ca(c, f) {
  ...
  var Zr = Wr ? mn(Wr, Object) : Da,
    kt = ga;
  ((vn && kt(new vn(new ArrayBuffer(1))) != ot) ||
    (se && kt(new se()) != h) ||
    (yn && kt(yn.resolve()) != T) ||
    (Tn && kt(new Tn()) != k) ||
    (bn && kt(new bn()) != b)) &&
  ...
  function Ea(c) {
    ...
    return (
      f &&
        typeof c[0] == 'string' &&
        pt.call(c, 'index') &&
        ((d.index = c.index), (d.input = c.input)),
      d
    );
  }
  function Na(c) {
  ...
  function Oa(c, f) {
    return (
      (f = f ?? i), !!f && (typeof c == 'number' || bo.test(c)) && c > -1 && c % 1 == 0 && c < f
    );
  }
  function Aa(c) {
    var f = typeof c;
  ...
  function ti(c) {
    var f = c && c.constructor,
      d = (typeof f == 'function' && f.prototype) || Se;
    return c === d;
  }
  function St(c) {
    if (c != null) {
  ...
  function Ra(c) {
    return Fa(c) && pt.call(c, 'callee') && (!Fo.call(c, 'callee') || _e.call(c) == s);
  }
...
class Pe {
  ...
  bpm;
  time;
  constructor({ ticks: e, bpm: n, time: r }) {
...
class Ti {
  ...
  numerator;
  denominator;
  constructor({ ticks: e, numerator: n, denominator: r }) {
...
const dr = () => {},
  ...
  x = (t, e) => Vu.call(t, e),
  E = Array.isArray,
  Qt = t => an(t) === '[object Map]',
  Ru = t => an(t) === '[object Set]',
  L = t => typeof t == 'function',
  st = t => typeof t == 'string',
  gr = t => typeof t == 'symbol',
  X = t => t !== null && typeof t == 'object',
  Fu = t => X(t) && L(t.then) && L(t.catch),
  Uu = Object.prototype.toString,
  an = t => Uu.call(t),
  Fs = t => an(t).slice(8, -1),
  Bu = t => an(t) === '[object Object]',
  mr = t => st(t) && t !== 'NaN' && t[0] !== '-' && '' + parseInt(t, 10) === t,
  $u = t => {
    const e = /* @__PURE__ */ Object.create(null);
    return n => e[n] || (e[n] = t(n));
  },
  hh = $u(t => t.charAt(0).toUpperCase() + t.slice(1)),
  We = (t, e) => !Object.is(t, e),
  Du = (t, e, n) => {
...
const qn = 30;
let K;
const Pt = Symbol(process.env.NODE_ENV !== 'production' ? 'iterate' : ''),
...
function nt(t, e, n) {
  if (Ot && K) {
    ...
    i || r.set(n, (i = Ln()));
    const s =
      process.env.NODE_ENV !== 'production' ? { effect: K, target: t, type: e, key: n } : void 0;
    Ju(i, s);
  }
}
function Ju(t, e) {
  let n = !1;
  ue <= qn ? Bs(t) || ((t.n |= yt), (n = !Us(t))) : (n = !t.has(K)),
    n &&
      (t.add(K),
      K.deps.push(t),
      process.env.NODE_ENV !== 'production' &&
        K.onTrack &&
        K.onTrack(Object.assign({ effect: K }, e)));
}
function Tt(t, e, n, r, i, s) {
  ...
  if (e === 'clear') a = [...o.values()];
    ...
    switch ((n !== void 0 && a.push(o.get(n)), e)) {
      case 'add':
        E(t) ? mr(n) && a.push(o.get('length')) : (a.push(o.get(Pt)), Qt(t) && a.push(o.get(Kn)));
        break;
      case 'delete':
        E(t) || (a.push(o.get(Pt)), Qt(t) && a.push(o.get(Kn)));
        break;
      case 'set':
        Qt(t) && a.push(o.get(Pt));
        break;
    }
  const u =
    process.env.NODE_ENV !== 'production'
      ? { target: t, type: e, key: n, newValue: r, oldValue: i, oldTarget: s }
      : void 0;
  if (a.length === 1) a[0] && (process.env.NODE_ENV !== 'production' ? Oe(a[0], u) : Oe(a[0]));
  else {
    const l = [];
    for (const g of a) g && l.push(...g);
    process.env.NODE_ENV !== 'production' ? Oe(Ln(l), u) : Oe(Ln(l));
  }
}
function Oe(t, e) {
  const n = E(t) ? t : [...t];
  for (const r of n) r.computed && Si(r, e);
  for (const r of n) r.computed || Si(r, e);
}
function Si(t, e) {
  (t !== K || t.allowRecurse) &&
    (process.env.NODE_ENV !== 'production' && t.onTrigger && t.onTrigger(it({ effect: t }, e)),
    t.scheduler ? t.scheduler() : t.run());
}
const Wu = /* @__PURE__ */ Cu('__proto__,__v_isRef,__isVue'),
  Hs = new Set(
...
function Qu() {
  ...
  return (
    ['includes', 'indexOf', 'lastIndexOf'].forEach(e => {
      t[e] = function (...n) {
        const r = _(this);
        for (let s = 0, o = this.length; s < o; s++) nt(r, 'get', s + '');
        const i = r[e](...n);
...
function Ir(t = !1, e = !1) {
  return function (r, i, s) {
    ...
    if (i === '__v_raw' && s === (t ? (e ? Js : Gs) : e ? dl : zs).get(r)) return r;
    const o = E(r);
    if (!t && o && x(_i, i)) return Reflect.get(_i, i, s);
    const a = Reflect.get(r, i, s);
    return (gr(i) ? Hs.has(i) : Wu(i)) || (t || nt(r, 'get', i), e)
      ? a
      : $(a)
      ? o && mr(i)
        ? a
...
function tl(t = !1) {
  return function (n, r, i, s) {
    let o = n[r];
    if (Ft(o) && $(o) && !$(i)) return !1;
    if (!t && !Ft(i) && (zn(i) || ((i = _(i)), (o = _(o))), !E(n) && $(o) && !$(i)))
      return (o.value = i), !0;
    const a = E(n) && mr(r) ? Number(r) < n.length : x(n, r),
...
const il = {
  ...
  qs = {
    ...
    set(t, e) {
      return (
        process.env.NODE_ENV !== 'production' &&
          wi(`Set operation on key "${String(e)}" failed: target is readonly.`, t),
        !0
      );
    },
    deleteProperty(t, e) {
      return (
        process.env.NODE_ENV !== 'production' &&
          wi(`Delete operation on key "${String(e)}" failed: target is readonly.`, t),
        !0
      );
    },
  },
...
function Me(t, e = !1) {
  const n = this.__v_raw,
    ...
    i = _(t);
  return (
    e || (t !== i && nt(r, 'has', t), nt(r, 'has', i)), t === i ? n.has(t) : n.has(t) || n.has(i)
  );
}
function Ve(t, e = !1) {
...
function Ni() {
  const t = _(this),
    e = t.size !== 0,
    n = process.env.NODE_ENV !== 'production' ? (Qt(t) ? new Map(t) : new Set(t)) : void 0,
    r = t.clear();
...
function Tr(t, e, n, r, i) {
  if (!X(t)) return process.env.NODE_ENV, t;
...
function Ys(t, e, n) {
  return st(e)
    ...
    ? n
      ...
      : [`${t}=${e}`]
    : $(e)
    ? ((e = Ys(t, _(e.value), !0)), n ? e : [`${t}=Ref<`, e, '>'])
    : L(e)
    ? [`${t}=fn${e.name ? `<${e.name}>` : ''}`]
    : ((e = _(e)), n ? e : [`${t}=`, e]);
}
...
function Gn(t, e, n, r) {
  ...
  const i = [];
  for (let s = 0; s < t.length; s++) i.push(Gn(t[s], e, n, r));
  return i;
}
function Qs(t, e, n, r = !0) {
  ...
  if (e) {
    let s = e.parent;
    const o = e.proxy,
      a = process.env.NODE_ENV !== 'production' ? Xs[n] : n;
    for (; s; ) {
      const l = s.ec;
      if (l) {
        for (let g = 0; g < l.length; g++) if (l[g](t, o, a) === !1) return;
      }
      s = s.parent;
    }
...
function to(t) {
  (!rt.length || !rt.includes(t, Ye && t.allowRecurse ? mt + 1 : mt)) &&
    t !== Wn &&
    (t.id == null ? rt.push(t) : rt.splice(Pl(t.id), 0, t), eo());
}
function eo() {
...
const ve = t => (t.id == null ? 1 / 0 : t.id);
function io(t) {
  (Jn = !1),
    (Ye = !0),
    process.env.NODE_ENV !== 'production' && (t = t || /* @__PURE__ */ new Map()),
    Sr(t),
    rt.sort((n, r) => ve(n) - ve(r));
  const e = process.env.NODE_ENV !== 'production' ? n => _r(t, n) : dr;
  try {
    for (mt = 0; mt < rt.length; mt++) {
      const n = rt[mt];
      if (n && n.active !== !1) {
        if (process.env.NODE_ENV !== 'production' && e(n)) continue;
        Vt(n, null, 14);
      }
    }
  } finally {
    (mt = 0),
      ...
      (Ye = !1),
      (kr = null),
      (rt.length || fe.length || he.length) && io(t);
  }
}
function _r(t, e) {
...
function Rl(t, e) {
  const n = Xe.get(t);
  if (!n) return;
  (e = pe(e)), Pi(n.initialDef, e);
  const r = [...n.instances];
  for (const i of r) {
    const s = pe(i.type);
    ce.has(s) || (s !== n.initialDef && Pi(s, e), ce.add(s)),
      i.appContext.optionsCache.delete(i.type),
      i.ceReload
        ? (ce.add(s), i.ceReload(e.styles), ce.delete(s))
        : i.parent
        ? (to(i.parent.update),
          i.parent.type.__asyncLoader && i.parent.ceReload && i.parent.ceReload(e.styles))
        : i.appContext.reload
        ? i.appContext.reload()
        : typeof window < 'u' && window.location.reload();
  }
  ro(() => {
    for (const i of r) ce.delete(pe(i.type));
  });
}
function Pi(t, e) {
  it(t, e);
...
function $l(t, e, { immediate: n, deep: r, flush: i, onTrack: s, onTrigger: o } = Y) {
  ...
  if (
    ($(t)
      ...
      : E(t)
      ? ((p = !0),
        (g = t.some(w => At(w) || zn(w))),
        (l = () =>
          t.map(w => {
            if ($(w)) return w.value;
            if (At(w)) return jt(w);
            if (L(w)) return Vt(w, u, 2);
      ...
      ? e
        ? (l = () => Vt(t, u, 2))
        : (l = () => {
            if (!(u && u.isUnmounted)) return h && h(), Gn(t, u, 3, [m]);
          })
      : ((l = dr), process.env.NODE_ENV !== 'production' && a(t)),
    e && r)
  ) {
    const w = l;
    l = () => jt(w());
  ...
  const T = () => {
    if (!!k.active)
      if (e) {
        const w = k.run();
        (r || g || (p ? w.some((j, b) => We(j, I[b])) : We(w, I))) &&
          (h && h(), Gn(e, u, 3, [w, I === Oi ? void 0 : I, m]), (I = w));
      } else k.run();
  };
  T.allowRecurse = !!e;
  let y;
  ...
  const k = new Gu(l, y);
  return (
    process.env.NODE_ENV !== 'production' && ((k.onTrack = s), (k.onTrigger = o)),
    e ? (n ? T() : (I = k.run())) : i === 'post' ? Vi(k.run.bind(k), u && u.suspense) : k.run(),
    () => {
...
function Dl(t, e, n) {
  const r = this.proxy,
    i = st(t) ? (t.includes('.') ? Ll(r, t) : () => r[t]) : t.bind(r, r);
  let s;
...
function jt(t, e) {
  if (!X(t) || t.__v_skip || ((e = e || /* @__PURE__ */ new Set()), e.has(t))) return t;
  if ((e.add(t), $(t))) jt(t.value, e);
  else if (E(t)) for (let n = 0; n < t.length; n++) jt(t[n], e);
  else if (Ru(t) || Qt(t))
    t.forEach(n => {
      jt(n, e);
    });
  else if (Bu(t)) for (const n in t) jt(t[n], e);
  return t;
}
const Hl = Symbol(),
  jn = t => (t ? (uf(t) ? lf(t) || t.proxy : jn(t.parent)) : null),
  Qe = /* @__PURE__ */ it(/* @__PURE__ */ Object.create(null), {
    $: t => t,
    $el: t => t.vnode.el,
    $data: t => t.data,
  ...
  Kl = {
    get({ _: t }, e) {
      ...
      if (process.env.NODE_ENV !== 'production' && e === '__isVue') return !0;
      ...
      if (e[0] !== '$') {
        ...
        if (m !== void 0)
          ...
          if (r !== Y && x(r, e)) return (o[e] = 1), r[e];
          if (i !== Y && x(i, e)) return (o[e] = 2), i[e];
          if ((l = t.propsOptions[0]) && x(l, e)) return (o[e] = 3), s[e];
          if (n !== Y && x(n, e)) return (o[e] = 4), n[e];
      ...
      if (g)
        return (
          e === '$attrs' && (nt(t, 'get', e), process.env.NODE_ENV !== 'production' && void 0), g(t)
        );
      if ((p = a.__cssModules) && (p = p[e])) return p;
      if (n !== Y && x(n, e)) return (o[e] = 4), n[e];
      if (((h = u.config.globalProperties), x(h, e))) return h[e];
      process.env.NODE_ENV !== 'production' &&
        Nt &&
        (!st(e) || e.indexOf('__v') !== 0) &&
        (i !== Y && ql(e[0]) && x(i, e)
          ? z(
    ...
    set({ _: t }, e, n) {
      ...
      return i !== Y && x(i, e)
        ...
        : x(t.props, e)
        ? (process.env.NODE_ENV !== 'production' &&
            z(`Attempting to mutate prop "${e}". Props are readonly.`, t),
          !1)
        : e[0] === '$' && e.slice(1) in t
        ? (process.env.NODE_ENV !== 'production' &&
            z(
          ...
          !1)
        : (process.env.NODE_ENV !== 'production' && e in t.appContext.config.globalProperties
    ...
    has(
      ...
      return (
        ...
        x(r, o) ||
        x(Qe, o) ||
        x(i.config.globalProperties, o)
      );
    },
    defineProperty(t, e, n) {
      return (
        n.get != null ? (t._.accessCache[e] = 0) : x(n, 'value') && this.set(t, e, n.value, null),
...
function Gl(t) {
  ...
  return (
    a
      ...
      : !i.length && !n && !r
      ? (u = e)
      : ((u = {}), i.length && i.forEach(l => Ze(u, l, o, !0)), Ze(u, e, o)),
    s.set(e, u),
    u
  );
}
...
function jl(t, e) {
  ...
  for (const r in e) n[r] = U(t[r], e[r]);
  return n;
}
function Yl() {
  return {
...
const Vi = Bl,
  Xl = t => t.__isTeleport,
  so = Symbol(process.env.NODE_ENV !== 'production' ? 'Fragment' : void 0),
  Ql = Symbol(process.env.NODE_ENV !== 'production' ? 'Text' : void 0),
  Zl = Symbol(process.env.NODE_ENV !== 'production' ? 'Comment' : void 0);
...
const ef = (...t) => co(...t),
  ...
  He = ({ ref: t, ref_key: e, ref_for: n }) =>
    t != null ? (st(t) || $(t) || L(t) ? { i: Nt, r: t, k: e, f: !!n } : t) : null;
function nf(t, e = null, n = null, r = 0, i = null, s = t === so ? 0 : 1, o = !1, a = !1) {
  ...
  return (
    a ? (Cr(u, n), s & 128 && t.normalize(u)) : n && (u.shapeFlag |= st(n) ? 8 : 16),
    process.env.NODE_ENV !== 'production' &&
      u.key !== u.key &&
      z('VNode created with invalid key (NaN). VNode type:', u.type),
    !o && Yt && (u.patchFlag > 0 || s & 6) && u.patchFlag !== 32 && Yt.push(u),
    u
  );
}
...
function co(t, e = null, n = null, r = 0, i = null, s = !1) {
  if (
    ((!t || t === Hl) &&
      (process.env.NODE_ENV !== 'production' &&
        !t &&
        z(`Invalid vnode type when creating vnode: ${t}.`),
      (t = Zl)),
    tf(t))
  ) {
    const a = tn(t, e, !0);
    return (
      n && Cr(a, n),
      !s && Yt && (a.shapeFlag & 6 ? (Yt[Yt.indexOf(t)] = a) : Yt.push(a)),
      (a.patchFlag |= -2),
      a
    );
  }
  if ((ho(t) && (t = t.__vccOpts), e)) {
    ...
    a && !st(a) && (e.class = pr(a)),
      X(u) && (je(u) && !E(u) && (u = it({}, u)), (e.style = hr(u)));
  }
  const o = st(t) ? 1 : Ul(t) ? 128 : Xl(t) ? 64 : X(t) ? 4 : L(t) ? 2 : 0;
  return (
    process.env.NODE_ENV !== 'production' &&
      o & 4 &&
      je(t) &&
...
function Cr(t, e) {
  ...
  if (e == null) e = null;
    ...
    if (r & 65) {
      ...
      !i && !(oo in e)
        ? (e._ctx = Nt)
        : i === 3 && Nt && (Nt.slots._ === 1 ? (e._ = 1) : ((e._ = 2), (t.patchFlag |= 1024)));
    }
  else
    L(e)
      ? ((e = { default: e, _ctx: Nt }), (n = 32))
      : ((e = String(e)), r & 64 ? ((n = 16), (e = [of(e)])) : (n = 8));
...
function af(...t) {
  ...
  for (let n = 0; n < t.length; n++) {
    const r = t[n];
    for (const i in r)
      if (i === 'class') e.class !== r.class && (e.class = pr([e.class, r.class]));
      else if (i === 'style') e.style = hr([e.style, r.style]);
      else if (Au(i)) {
        const s = e[i],
          o = r[i];
...
function lf(t) {
  if (t.exposed)
    return (
      t.exposeProxy ||
      (t.exposeProxy = new Proxy(Tl(Il(t.exposed)), {
        get(e, n) {
          if (n in e) return e[n];
          if (n in Qe) return Qe[n](t);
        },
      }))
    );
}
const ff = /(?:^|[-_])(\w)/g,
  hf = t => t.replace(ff, e => e.toUpperCase()).replace(/[-_]/g, '');
function lo(t, e = !0) {
...
function pf() {
  ...
  const t = { style: 'color:#3ba776' },
    ...
    i = {
      header(p) {
        return X(p)
          ? p.__isVue
            ? ['div', t, 'VueInstance']
            : $(p)
            ? ['div', {}, ['span', t, g(p)], '<', a(p.value), '>']
            : At(p)
            ? [
                'div',
                {},
                ['span', t, On(p) ? 'ShallowReactive' : 'Reactive'],
                '<',
                a(p),
                `>${Ft(p) ? ' (readonly)' : ''}`,
              ]
            : Ft(p)
            ? ['div', {}, ['span', t, On(p) ? 'ShallowReadonly' : 'Readonly'], '<', a(p), '>']
            : null
          : null;
      },
      hasBody(p) {
      ...
      body(p) {
        if (p && p.__isVue) return ['div', {}, ...s(p.$)];
      },
    };
  function s(p) {
    const h = [];
    p.type.props && p.props && h.push(o('props', _(p.props))),
      p.setupState !== Y && h.push(o('setup', p.setupState)),
      p.data !== Y && h.push(o('data', _(p.data)));
    const m = u(p, 'computed');
    m && h.push(o('computed', m));
    const I = u(p, 'inject');
    return (
      I && h.push(o('injected', I)),
      h.push([
        'div',
        {},
        [
      ...
      Object.keys(h).length
        ? [
            ...
            [
              ...
              ...Object.keys(h).map(m => ['div', {}, ['span', r, m + ': '], a(h[m], !1)]),
            ],
          ]
        : ['span', {}]
    );
  ...
  function u(p, h) {
    ...
    if (L(m)) return;
    const I = {};
    for (const T in p.ctx) l(m, T, h) && (I[T] = p.ctx[T]);
    return I;
  }
  function l(p, h, m) {
    const I = p[m];
    if (
      (E(I) && I.includes(h)) ||
      (X(I) && h in I) ||
      (p.extends && l(p.extends, h, m)) ||
      (p.mixins && p.mixins.some(T => l(T, h, m)))
    )
      return !0;
  }
  function g(p) {
    return On(p) ? 'ShallowRef' : p.effect ? 'ComputedRef' : 'Ref';
  }
...
function en(t) {
  const e = t.split(' // ');
  if (e.length < 4) throw new Error('Invalid audio plugin tuneflow id.');
  return {
    name: e[2],
...
function Tf(t, e) {
  const n = en(t),
    r = en(e);
  if (M.keys(n).length !== M.keys(r).length) return !1;
  for (const i of M.keys(n)) if (i !== 'pluginVersion' && n[i] !== r[i]) return !1;
  return !0;
}
class mh {
  tempoInfos = [];
  ...
  secondsToTick(e) {
    ...
    for (
      ...
      this.tempoInfos[this.currentTempoIndex + 1].time <= e;
    ...
    const r = e - n.time,
      i = this.ticksPerSecondAtTempoTick[n.ticks];
  ...
  tickToSeconds(e) {
    ...
    for (
      ;
      this.tempoInfos[this.currentTempoIndex + 1] &&
      this.tempoInfos[this.currentTempoIndex + 1].ticks <= e;
...
var wf = /* @__PURE__ */ (t => (
  (t[(t.BassDrum2 = 35)] = 'BassDrum2'),
  (t[(t.BassDrum1 = 36)] = 'BassDrum1'),
  (t[(t.SideStick = 37)] = 'SideStick'),
  (t[(t.SnareDrum1 = 38)] = 'SnareDrum1'),
  (t[(t.HandClap = 39)] = 'HandClap'),
  (t[(t.SnareDrum2 = 40)] = 'SnareDrum2'),
  (t[(t.LowTom2 = 41)] = 'LowTom2'),
  (t[(t.ClosedHiHat = 42)] = 'ClosedHiHat'),
  (t[(t.LowTom1 = 43)] = 'LowTom1'),
  (t[(t.PedalHiHat = 44)] = 'PedalHiHat'),
  (t[(t.MidTom2 = 45)] = 'MidTom2'),
  (t[(t.OpenHiHat = 46)] = 'OpenHiHat'),
  (t[(t.MidTom1 = 47)] = 'MidTom1'),
  (t[(t.HighTom2 = 48)] = 'HighTom2'),
  (t[(t.CrashCymbal1 = 49)] = 'CrashCymbal1'),
  (t[(t.HighTom1 = 50)] = 'HighTom1'),
  (t[(t.RideCymbal1 = 51)] = 'RideCymbal1'),
  (t[(t.ChineseCymbal = 52)] = 'ChineseCymbal'),
  (t[(t.RideBell = 53)] = 'RideBell'),
  (t[(t.Tambourine = 54)] = 'Tambourine'),
  (t[(t.SplashCymbal = 55)] = 'SplashCymbal'),
  (t[(t.Cowbell = 56)] = 'Cowbell'),
  (t[(t.CrashCymbal2 = 57)] = 'CrashCymbal2'),
  (t[(t.VibraSlap = 58)] = 'VibraSlap'),
  (t[(t.RideCymbal2 = 59)] = 'RideCymbal2'),
  (t[(t.HighBongo = 60)] = 'HighBongo'),
  (t[(t.LowBongo = 61)] = 'LowBongo'),
  (t[(t.MuteHighConga = 62)] = 'MuteHighConga'),
  (t[(t.OpenHighConga = 63)] = 'OpenHighConga'),
  (t[(t.LowConga = 64)] = 'LowConga'),
  (t[(t.HighTimbale = 65)] = 'HighTimbale'),
  (t[(t.LowTimbale = 66)] = 'LowTimbale'),
  (t[(t.HighAgogo = 67)] = 'HighAgogo'),
  (t[(t.LowAgogo = 68)] = 'LowAgogo'),
  (t[(t.Cabasa = 69)] = 'Cabasa'),
  (t[(t.Maracas = 70)] = 'Maracas'),
  (t[(t.ShortWhistle = 71)] = 'ShortWhistle'),
  (t[(t.LongWhistle = 72)] = 'LongWhistle'),
  (t[(t.ShortGuiro = 73)] = 'ShortGuiro'),
  (t[(t.LongGuiro = 74)] = 'LongGuiro'),
  (t[(t.Claves = 75)] = 'Claves'),
  (t[(t.HighWoodBlock = 76)] = 'HighWoodBlock'),
  (t[(t.LowWoodBlock = 77)] = 'LowWoodBlock'),
  (t[(t.MuteCuica = 78)] = 'MuteCuica'),
  (t[(t.OpenCuica = 79)] = 'OpenCuica'),
  (t[(t.MuteTriangle = 80)] = 'MuteTriangle'),
  (t[(t.OpenTriangle = 81)] = 'OpenTriangle'),
  (t[(t.Shaker = 82)] = 'Shaker'),
  t
))(wf || {});
class un {
  name;
  ...
  constructor(e, n, r, i) {
    (this.name = e),
      ...
      (this.localInstanceIdInternal = un.generateAudioPluginInstanceIdInternal());
  }
  getTuneflowId() {
...
class It {
  ...
  idInternal;
  clipInternal;
  constructor({ pitch: e, velocity: n, startTick: r, endTick: i, id: s, clip: o }) {
    (this.pitch = e),
      (this.velocity = n),
      (this.startTick = r),
      (this.endTick = i),
  ...
  setPitch(e) {
    if (!It.isValidPitch(e)) throw new Error(`Invalid pitch ${e}`);
    this.pitch = e;
  }
  getVelocity() {
  ...
  equals(e) {
    return (
      this.startTick === e.getStartTick() &&
      this.endTick === e.getEndTick() &&
  ...
  moveNote(e) {
    ...
    n && n.deleteNote(this),
      (this.startTick = Math.max(0, this.startTick + e)),
      (this.endTick = this.endTick + e),
      !!this.isRangeValid() && n && n.orderedInsertNote(n.getRawNotes(), this);
  }
  adjustLeft(e) {
    if (e === 0) return;
    const n = this.clipInternal;
...
var le = /* @__PURE__ */ (t => (
  (t[(t.MIDI_CLIP = 1)] = 'MIDI_CLIP'), (t[(t.AUDIO_CLIP = 2)] = 'AUDIO_CLIP'), t
))(le || {});
class et {
  song;
  track;
  ...
  constructor({
    ...
    if (
      ...
      if (!a) throw new Error('Audio clip data must be provided for audio clips.');
      (this.audioClipData = {
  ...
  setAudioFile(e, n, r) {
    this.audioClipData
      ? ((this.audioClipData.audioFilePath = e),
        (this.audioClipData.startTick = n),
        (this.audioClipData.duration = r))
      : (this.audioClipData = {
          audioFilePath: e,
          startTick: n,
          duration: r,
  ...
  getAudioDuration() {
    if (!(this.type !== 2 || !this.audioClipData)) return this.audioClipData.duration;
  }
  getClipStartTick() {
  ...
  createNote({
    ...
    if (
      this.type !== 1 ||
      !It.isValidPitch(e) ||
      !It.isNoteRangeValid(r, i) ||
      !It.isNoteVelocityValid(n)
    )
      return null;
    const a = new It({
      pitch: e,
    ...
    return (
      r < this.clipStartTick && s && this.adjustClipLeft(r, o),
      i > this.clipEndTick && s && this.adjustClipRight(i, o),
      this.orderedInsertNote(this.notes, a),
      a
    );
  }
  getNoteIndexInternal(e) {
    ...
    for (let r = Math.max(0, n); r < this.notes.length; r += 1) {
      ...
      if (i && i === e) return r;
      if (i && i.getStartTick() > e.getStartTick()) break;
    }
    return -1;
  }
  deleteNote(e) {
  ...
  moveClip(e, n) {
    const r = Math.max(0, this.clipStartTick + e),
      i = this.clipEndTick + e;
    if (i < 0) {
      this.deleteFromParent(!0);
      return;
    }
    ...
    if (this.type === 1) {
      ...
      if (!this.audioClipData) throw new Error('Cannot move audio clip without audio data');
      const a = this.song,
        u = a.tickToSeconds(this.audioClipData.startTick),
        l = a.tickToSeconds(s),
        p = a.tickToSeconds(o) - l,
        h = l - u,
        m = a.tickToSeconds(this.clipStartTick + e),
        I = m - h,
        T = m + p;
      if (
        ((this.clipStartTick = r),
        (this.clipEndTick = a.secondsToTick(T)),
        (this.audioClipData.startTick = a.secondsToTick(I)),
        this.clipEndTick < 0)
      ) {
        this.deleteFromParent(!0);
        return;
    ...
    this.track &&
      ...
      n && this.track.getAutomation().moveAllPointsWithinRange(s, o, e, 0));
  }
  moveClipTo(e, n) {
  ...
  getNotesByIds(e) {
    const n = new Set(e),
      r = [];
    for (const i of this.notes) n.has(i.getId()) && r.push(i);
    return r;
  }
  getAudioEndTick() {
    if (this.type !== 2 || !this.audioClipData) return;
    const e = this.getAudioDuration();
    if (!M.isNumber(e)) return;
  ...
  static getNotesInRangeImpl(e, n, r, i, s, o) {
    let a = Math.max(
      0,
      V.lt(e, i(n), (l, g) => s(l) - s(g)),
    );
    for (; e[a] && !et.isNoteInClip(s(e[a]), o(e[a]), n, r); ) a += 1;
    if (a >= e.length) return [];
    let u = Math.min(
      e.length - 1,
      V.gt(e, i(r), (l, g) => s(l) - s(g)),
    );
    for (; e[u] && !et.isNoteInClip(s(e[u]), o(e[u]), n, r); ) u -= 1;
  ...
  static getNotePlayableRange(e, n, r, i) {
    if (!et.isNoteInClip(e, n, r, i)) return null;
  ...
  trimConflictPartInternal(e, n) {
    const r = Math.max(e, this.getClipStartTick()),
      i = Math.min(n, this.getClipEndTick());
    if (!(r > i) && !(r > this.getClipEndTick() || i < this.getClipStartTick())) {
      ...
      r > this.getClipStartTick() && r <= this.getClipEndTick()
        ...
        : i < this.getClipEndTick() &&
          i >= this.getClipStartTick() &&
          this.adjustClipLeft(i + 1, !1);
    }
  }
  getNextNoteIdInternal() {
    const e = this.nextNoteIdInternal;
    return (
      this.nextNoteIdInternal >= 2147483647
...
var Yn = /* @__PURE__ */ (t => (
  ...
  (t[(t.VOLUME = 1)] = 'VOLUME'),
  (t[(t.PAN = 2)] = 'PAN'),
  (t[(t.AUDIO_PLUGIN = 3)] = 'AUDIO_PLUGIN'),
  t
))(Yn || {});
class tt {
  type;
  ...
  static decodeAutomationTarget(e) {
    const n = e.split('^^');
    if (n.length === 0) throw new Error(`Invalid automation target id: ${e}`);
    const r = Number(n[0]);
...
class te {
  ...
  static getPointsInRangeImpl(e, n, r) {
    const i = V.ge(e, { tick: n }, (o, a) => o.tick - a.tick),
      s = [];
  ...
  removePointsInRange(e, n) {
    ...
    if (r >= this.points.length) return;
    let i = r;
    for (; i + 1 < this.points.length && this.points[i + 1].tick <= n; ) i += 1;
  ...
  movePoints(e, n, r, i = !0) {
    ...
    if (!(o === void 0 || a === void 0)) {
      if (i) {
        if (n < 0) {
          const l = Math.max(0, this.points[o].tick + n),
            g = V.gt(this.points, { tick: l }, (p, h) => p.tick - h.tick);
          g < o && this.points.splice(g, o - g);
        } else if (n > 0) {
          const l = this.points[a].tick + n,
            g = V.lt(this.points, { tick: l }, (p, h) => p.tick - h.tick);
  ...
  clone() {
    ...
    for (const n of this.points) e.addPoint(n.tick, n.value, !1);
    return e;
  }
  getNextPointIdInternal() {
    const e = this.nextPointIdInternal;
    return (
      this.nextPointIdInternal >= 2147483647
  ...
  static orderedInsertPointInternal(e, n, r = !1) {
    ...
    for (; r && e[i] && e[i].tick === n.tick; ) e.splice(i, 1);
    e.splice(i, 0, n);
  }
}
class xr {
  ...
  removeAllPointsWithinRange(e, n) {
    for (const r of M.keys(this.targetValues)) this.targetValues[r].removePointsInRange(e, n);
  }
  ...
  clone() {
    const e = new xr();
    for (const n of this.targets) e.addAutomation(n.clone());
    for (const n of M.keys(this.targetValues)) {
...
var Wt = /* @__PURE__ */ (t => (
  (t[(t.MIDI_TRACK = 1)] = 'MIDI_TRACK'),
  (t[(t.AUDIO_TRACK = 2)] = 'AUDIO_TRACK'),
  (t[(t.MASTER_TRACK = 3)] = 'MASTER_TRACK'),
  t
))(Wt || {});
class Xt {
  insturment;
  ...
  constructor({
    type: e,
    song: n,
    uuid: r = Xt.generateTrackIdInternal(),
    clips: i = [],
    instrument: s,
    ...
    (this.song = n),
      ...
      s
        ? (this.insturment = s)
        : e === 1 &&
          (this.insturment = new de({
            program: 0,
            isDrum: !1,
          })),
      (this.clips = [...i]),
      (this.suggestedInstruments = [...o]),
      (this.uuid = r),
      (this.volume = a),
      (this.solo = u),
      (this.muted = l),
  ...
  setSamplerPlugin(e, n = !0) {
    if (this.type !== 1) return;
    const r =
        (!this.samplerPlugin && !!e) ||
        (!e && !!this.samplerPlugin) ||
        (!!e && !!this.samplerPlugin && !e.matchesTfId(this.samplerPlugin.getTuneflowId())),
      i = this.samplerPlugin;
    (this.samplerPlugin = e),
      r && i && n && this.automation.removeAutomationOfPlugin(i.getInstanceId());
  }
  getAudioPlugins() {
  ...
  getClipById(e) {
    for (const n of this.clips) if (n.getId() === e) return n;
    return null;
  }
  getClips() {
    return this.clips;
  ...
  getClipsOverlappingWith(e, n) {
    ...
    for (let s = Math.max(i, 0); s < this.clips.length; s += 1) {
      ...
      if (!(o.getClipEndTick() < e)) {
        if (o.getClipStartTick() > n) break;
        r.push(o);
      }
    }
    return r;
  }
  createMIDIClip({ clipStartTick: e, clipEndTick: n = void 0, insertClip: r = !0 }) {
    if (!M.isNumber(e)) throw new Error('clipStartTick must be specified when creating a clip.');
    const i = n ?? e + 1;
    if (i < e)
      throw new Error(
  ...
  createAudioClip({ clipStartTick: e, audioClipData: n, clipEndTick: r, insertClip: i = !0 }) {
    if (!M.isNumber(e)) throw new Error('clipStartTick must be specified when creating a clip.');
    const s = new et({
      id: et.generateClipIdInternal(),
      type: le.AUDIO_CLIP,
  ...
  insertClip(e) {
    if (e.getTrack() !== this) e.getTrack() && e.deleteFromParent(!1), (e.track = this);
    else return;
    this.resolveClipConflictInternal(e.getId(), e.getClipStartTick(), e.getClipEndTick()),
      this.orderedInsertClipInternal(e);
  }
  cloneClip(e) {
  ...
  hasAnyAutomation() {
    return (
      ...
      !M.isEmpty(this.automation.getAutomationTargetValues())
    );
  }
  ...
  resolveClipConflictInternal(e, n, r) {
    ...
    for (const s of i) s.getId() !== e && s.trimConflictPartInternal(n, r);
  }
...
class de {
  program;
  isDrum;
  constructor({ program: e, isDrum: n }) {
...
function Sf(t) {
  ...
  return (
    s & 32768
      ? ((i.framesPerSecond = 256 - (s >> 8)), (i.ticksPerFrame = s & 255))
      : (i.ticksPerBeat = s),
    i
  );
}
function _f(t) {
  ...
  function s() {
    ...
    if ((a & 240) === 240)
      if (a === 255) {
        ...
        switch (u) {
          ...
          case 88:
            ...
            return (
              (o.numerator = e.readUInt8()),
              (o.denominator = 1 << e.readUInt8()),
              l === 4
                ? ((o.metronome = e.readUInt8()), (o.thirtyseconds = e.readUInt8()))
                : ((o.metronome = 36), (o.thirtyseconds = 8)),
              o
            );
          case 89:
      ...
      var h;
      if ((a & 128) === 0) {
        if (i === null) throw 'Running status byte encountered before status byte';
        (h = a), (a = i), (o.running = !0);
      } else (h = e.readUInt8()), (i = a);
      var m = a >> 4;
      switch (((o.channel = a & 15), m)) {
        case 8:
          return (o.type = 'noteOff'), (o.noteNumber = h), (o.velocity = e.readUInt8()), o;
        case 9:
          var I = e.readUInt8();
          return (
            (o.type = I === 0 ? 'noteOff' : 'noteOn'),
            (o.noteNumber = h),
            (o.velocity = I),
            I === 0 && (o.byte9 = !0),
            o
        ...
        case 10:
          return (o.type = 'noteAftertouch'), (o.noteNumber = h), (o.amount = e.readUInt8()), o;
        case 11:
          return (o.type = 'controller'), (o.controllerType = h), (o.value = e.readUInt8()), o;
        case 12:
          return (o.type = 'programChange'), (o.programNumber = h), o;
        case 13:
          return (o.type = 'channelAftertouch'), (o.amount = h), o;
        case 14:
          return (o.type = 'pitchBend'), (o.value = h + (e.readUInt8() << 7) - 8192), o;
        default:
...
function xf(t, e) {
  ...
  var n = t.header || {},
    ...
    s = r.length,
    o = new O();
  for (Ef(o, n, s), i = 0; i < s; i++) Nf(o, r[i], e);
  return o.buffer;
}
function Ef(t, e, n) {
  var r = e.format == null ? 1 : e.format,
    i = 128;
  e.timeDivision
    ? (i = e.timeDivision)
    : e.ticksPerFrame && e.framesPerSecond
    ? (i = (-(e.framesPerSecond & 255) << 8) | (e.ticksPerFrame & 255))
    : e.ticksPerBeat && (i = e.ticksPerBeat & 32767);
  var s = new O();
...
function Nf(t, e, n) {
  var r = new O(),
    ...
    o = null;
  for (i = 0; i < s; i++)
    (n.running === !1 || (!n.running && !e[i].running)) && (o = null),
      (o = Pf(r, e[i], o, n.useByte9ForNoteOff));
...
function Pf(t, e, n, r) {
  ...
  switch ((t.writeVarInt(s), i)) {
    ...
    case 'smpteOffset':
      ...
      var l = { 24: 0, 25: 32, 29: 64, 30: 96 },
        g = (e.hour & 31) | l[e.frameRate];
      t.writeUInt8(g),
        t.writeUInt8(e.min),
        t.writeUInt8(e.sec),
    ...
    case 'timeSignature':
      ...
      var p = Math.floor(Math.log(e.denominator) / Math.LN2) & 255;
      t.writeUInt8(p), t.writeUInt8(e.metronome), t.writeUInt8(e.thirtyseconds || 8);
      break;
    case 'keySignature':
      t.writeUInt8(255),
        t.writeUInt8(89),
    ...
    case 'unknownMeta':
      e.metatypeByte != null &&
        (t.writeUInt8(255), t.writeUInt8(e.metatypeByte), t.writeVarInt(a.length), t.writeBytes(a));
      break;
    case 'sysEx':
  ...
  var r = (function () {
    function i(s) {
      ...
      if (
        ...
        n.set(this, s.header.ticksPerBeat),
          s.tracks.forEach(function (u) {
            u.forEach(function (l) {
              l.meta &&
                (l.type === 'timeSignature'
                  ? o.timeSignatures.push({
                      ticks: l.absoluteTime,
                      timeSignature: [l.numerator, l.denominator],
                    })
                  : l.type === 'setTempo'
                  ? o.tempos.push({
    ...
    return (
      (i.prototype.update = function () {
        ...
        this.tempos.sort(function (u, l) {
          ...
          this.tempos.forEach(function (u, l) {
            var g = l > 0 ? s.tempos[l - 1].bpm : s.tempos[0].bpm,
              p = u.ticks / s.ppq - a,
              h = (60 / g) * p;
            (u.time = h + o), (o = u.time), (a += p);
          }),
          this.timeSignatures.sort(function (u, l) {
            return u.ticks - l.ticks;
          }),
          this.timeSignatures.forEach(function (u, l) {
            var g = l > 0 ? s.timeSignatures[l - 1] : s.timeSignatures[0],
              p = (u.ticks - g.ticks) / s.ppq,
              h = p / g.timeSignature[0] / (g.timeSignature[1] / 4);
            (g.measures = g.measures || 0), (u.measures = h + g.measures);
          });
      }),
      ...
      (i.prototype.ticksToMeasures = function (s) {
        ...
        if (o !== -1) {
          var a = this.timeSignatures[o],
            u = (s - a.ticks) / this.ppq;
          return a.measures + u / (a.timeSignature[0] / a.timeSignature[1]) / 4;
        } else return s / this.ppq / 4;
      }),
      ...
      (i.prototype.fromJSON = function (s) {
        (this.name = s.name),
          (this.tempos = s.tempos.map(function (o) {
...
(function (t) {
  ...
  var e = /* @__PURE__ */ new WeakMap(),
    ...
    r = (function () {
      function i(s, o) {
        e.set(this, o),
          n.set(this, s.controllerType),
          (this.ticks = s.absoluteTime),
          (this.value = s.value);
      }
      return (
        Object.defineProperty(i.prototype, 'number', {
          get: function () {
            return n.get(this);
          },
          enumerable: !1,
...
function Mf() {
  return new Proxy(
    {},
    {
      get: function (t, e) {
        if (t[e]) return t[e];
        if (Be.controlChangeIds.hasOwnProperty(e)) return t[Be.controlChangeIds[e]];
      },
      set: function (t, e, n) {
        return (
          Be.controlChangeIds.hasOwnProperty(e) ? (t[Be.controlChangeIds[e]] = n) : (t[e] = n), !0
        );
      },
    },
  );
      ...
      Object.defineProperty(t.prototype, 'name', {
        get: function () {
          return this.percussion
            ? $e.DrumKitByPatchID[this.number]
            : $e.instrumentByPatchID[this.number];
        },
        set: function (e) {
  ...
  $f = (function () {
    function t(e, n, r) {
      Gt.set(this, r),
        ...
        (this.noteOffVelocity = n.velocity),
        (this.ticks = e.ticks),
        (this.durationTicks = n.ticks - e.ticks);
    }
    return (
      Object.defineProperty(t.prototype, 'name', {
        get: function () {
      ...
      Object.defineProperty(t.prototype, 'duration', {
        ...
        set: function (e) {
          var n = Gt.get(this),
            r = n.secondsToTicks(this.time + e);
  ...
  Kf = (function () {
    function t(e, n) {
      ...
      if (
        ((this.name = ''),
        (this.notes = []),
        (this.controlChanges = (0, Lf.createControlChanges)()),
        (this.pitchBends = []),
        De.set(this, n),
        e)
      ) {
      ...
      if (((this.instrument = new Bi.Instrument(e, this)), (this.channel = 0), e)) {
          ...
          var s = e.filter(function (h) {
            ...
            a = function () {
              ...
              var m = o.findIndex(function (T) {
                return T.noteNumber === h.noteNumber && T.absoluteTime >= h.absoluteTime;
              });
              if (m !== -1) {
                var I = o.splice(m, 1)[0];
                u.addNote({
                  durationTicks: I.absoluteTime - h.absoluteTime,
                  midi: h.noteNumber,
        ...
        var p = e.find(function (h) {
          return h.type === 'endOfTrack';
        });
        this.endOfTrackTicks = p !== void 0 ? p.absoluteTime : void 0;
      }
    }
    return (
      (t.prototype.addNote = function (e) {
        var n = De.get(this),
          r = new qf.Note(
            {
              midi: 0,
      ...
      (t.prototype.addCC = function (e) {
        ...
        return (
          ...
          (0, Mn.insert)(this.controlChanges[r.number], r, 'ticks'),
          this
        );
      }),
      (t.prototype.addPitchBend = function (e) {
        var n = De.get(this),
          r = new Hf.PitchBend({}, n);
      ...
      Object.defineProperty(t.prototype, 'duration', {
        get: function () {
          ...
          for (
            var e =
                this.notes[this.notes.length - 1].time + this.notes[this.notes.length - 1].duration,
              n = 0;
            n < this.notes.length - 1;
            n++
          ) {
      ...
      (t.prototype.fromJSON = function (e) {
        ...
        (this.name = e.name),
          ...
          (this.instrument = new Bi.Instrument(void 0, this)),
        ...
        for (var r in e.controlChanges)
          e.controlChanges[r] &&
            e.controlChanges[r].forEach(function (i) {
              n.addCC({
                number: i.number,
                ticks: i.ticks,
                value: i.value,
      ...
      (t.prototype.toJSON = function () {
        for (var e = {}, n = 0; n < 127; n++)
          this.controlChanges.hasOwnProperty(n) &&
            (e[n] = this.controlChanges[n].map(function (i) {
              return i.toJSON();
            }));
        var r = {
...
const Gf = /* @__PURE__ */ Object.freeze(
    /* @__PURE__ */ Object.defineProperty(
      {
        __proto__: null,
        flatten: zf,
...
function th(t) {
  for (var e = [], n = 0; n < 127; n++)
    t.controlChanges.hasOwnProperty(n) &&
      t.controlChanges[n].forEach(function (r) {
  ...
  var e = {
    ...
    tracks: gt(
      ...
      t.tracks.map(function (n) {
        return gt(gt(gt([ih(n.name), rh(n)], Qf(n), !0), th(n), !0), nh(n), !0);
      }),
      !0,
    ),
  };
  return (
    (e.tracks = e.tracks.map(function (n) {
...
(function (t) {
    ...
    n =
      ...
      function (p, h) {
        var m = {
          ...
          k;
        return (
          (k = { next: w(0), throw: w(1), return: w(2) }),
            ...
            try {
              ...
              switch (((T = 0), y && (b = [b[0] & 2, y.value]), b[0])) {
                ...
                default:
                  if (
                    ((y = m.trys),
                    !(y = y.length > 0 && y[y.length - 1]) && (b[0] === 6 || b[0] === 2))
                  ) {
                    m = 0;
                    continue;
                  }
    ...
    a = (function () {
      function p(h) {
        var m = this,
          I = null;
        if (h) {
          var T = h instanceof ArrayBuffer ? new Uint8Array(h) : h;
          (I = (0, r.parseMidi)(T)),
            I.tracks.forEach(function (y) {
              var k = 0;
      ...
      return (
        ...
        (p.prototype.fromJSON = function (h) {
          ...
          (this.header = new i.Header()),
            this.header.fromJSON(h.header),
            (this.tracks = h.tracks.map(function (I) {
  ...
  function g(p) {
    for (var h = [], m = 0; m < p.length; m++)
      for (
        var I = h.length, T = /* @__PURE__ */ new Map(), y = Array(16).fill(0), k = 0, w = p[m];
        k < w.length;
        k++
      ) {
        var j = w[k],
        ...
        if (P !== void 0) {
          ...
          var ot = y[P],
            Lt = ''.concat(ot, ' ').concat(P);
          T.has(Lt) ? (b = T.get(Lt)) : ((b = I + T.size), T.set(Lt, b));
        }
        h[b] || h.push([]), h[b].push(j);
      }
    return h;
  }
})(po);
class qe {
  ...
  getMasterTrack() {
    return (
      this.masterTrack ||
        (this.masterTrack = new Xt({
          type: Wt.MASTER_TRACK,
          song: this,
          uuid: Xt.generateTrackIdInternal(),
        })),
      this.masterTrack
    );
  }
  ...
  createTrack({ type: e, index: n, rank: r, assignDefaultSamplerPlugin: i = !1 }) {
    this.checkAccess('createTrack'),
      r == null || r === null
        ? (r = this.getNextTrackRank())
        : (this.nextTrackRank = Math.max(r + 1, this.nextTrackRank));
    const s = new Xt({
      type: e,
      song: this,
    ...
    return (
      i && e === Wt.MIDI_TRACK && s.setSamplerPlugin(s.createAudioPlugin(un.DEFAULT_SYNTH_TFID)),
      n != null ? this.tracks.splice(n, 0, s) : this.tracks.push(s),
      s
    );
  }
  cloneTrack(e) {
    ...
    if (
      ...
      r.setPan(e.getPan()),
      r.setSolo(e.getSolo()),
      r.setMuted(e.getMuted()),
      e.getType() === Wt.MIDI_TRACK)
    ) {
    ...
    } else e.getType(), Wt.AUDIO_TRACK;
    for (const i of e.getAudioPlugins()) r.addAudioPlugin(i.clone(r));
  ...
  createTempoChange({ ticks: e, bpm: n }) {
    if (this.PPQ <= 0)
    ...
    const r = new Pe({ ticks: e, bpm: n, time: this.tickToSeconds(e) }),
      i = V.ge(this.tempos, r, (s, o) => s.getTicks() - o.getTicks());
    return i < 0 ? this.tempos.push(r) : this.tempos.splice(i, 0, r), this.retimingTempoEvents(), r;
  }
  overwriteTempoChanges(e) {
    if (e.length === 0) throw new Error('Cannot clear all the tempo events.');
    const n = yi(e);
  ...
  createTimeSignature({ ticks: e, numerator: n, denominator: r }) {
    const i = new Ti({ ticks: e, numerator: n, denominator: r }),
      s = V.ge(this.timeSignatures, i, (o, a) => o.getTicks() - a.getTicks());
    return s < 0 ? this.timeSignatures.push(i) : this.timeSignatures.splice(s, 0, i), i;
  }
  getLastTick() {
    let e = 0;
    for (const n of this.tracks) e = Math.max(e, n.getTrackEndTick());
    return e;
  }
  getDuration() {
  ...
  tickToSeconds(e) {
    return qe.tickToSecondsImpl(e, this.getTempoChanges(), this.getResolution());
  }
  static tickToSecondsImpl(e, n, r) {
    ...
    const s = n[i],
      o = e - s.getTicks(),
      a = qe.tempoBPMToTicksPerSecond(s.getBpm(), r);
  ...
  secondsToTick(e) {
    ...
    const r = this.getTempoChanges()[n],
      i = e - r.getTime(),
      s = qe.tempoBPMToTicksPerSecond(r.getBpm(), this.getResolution());
    return Math.round(r.getTicks() + i * s);
  }
  static importMIDI(e, n, r = 0, i = !1) {
    const s = new po.Midi(n),
      o = r,
      a = 480 / s.header.ppq;
    if (i) {
      const u = [];
    ...
    for (const u of s.tracks) {
      ...
      for (const h of u.notes)
        g.createNote({
          pitch: h.midi,
          velocity: Math.round(h.velocity * 127),
          startTick: o + _t(h.ticks, a),
          endTick: o + _t(h.ticks + h.durationTicks, a),
        }),
          (p = Math.min(p, o + _t(h.ticks, a)));
      if (u.controlChanges[7]) {
        const h = new tt(Yn.VOLUME);
        l.getAutomation().addAutomation(h);
        const m = l.getAutomation().getAutomationValueByTarget(h);
        for (const I of u.controlChanges[7]) m.addPoint(o + _t(I.ticks, a), I.value);
      }
      if (u.controlChanges[10]) {
        const h = new tt(Yn.PAN);
        l.getAutomation().addAutomation(h);
        const m = l.getAutomation().getAutomationValueByTarget(h);
        for (const I of u.controlChanges[10]) m.addPoint(o + _t(I.ticks, a), I.value);
      }
      p !== Number.MAX_SAFE_INTEGER && g.adjustClipLeft(p);
    }
  }
  ...
  getNextTrackId() {
    const e = this.pluginContext,
      n = e.plugin.generatedTrackIdsInternal;
    if (e.numTracksCreatedByPlugin === n.length) n.push(Xt.generateTrackIdInternal());
  ...
  retimingTempoEvents() {
    ...
    for (const e of this.tempos) e.setTimeInternal(this.tickToSeconds(e.getTicks()));
  }
}
function _t(t, e) {
...
var B = /* @__PURE__ */ (t => (
  (t[(t.Slider = 1)] = 'Slider'),
  (t[(t.Input = 2)] = 'Input'),
  (t[(t.TrackSelector = 3)] = 'TrackSelector'),
  (t[(t.Pitch = 4)] = 'Pitch'),
  (t[(t.TrackPitchSelector = 5)] = 'TrackPitchSelector'),
  (t[(t.InstrumentSelector = 6)] = 'InstrumentSelector'),
  (t[(t.Select = 7)] = 'Select'),
  (t[(t.Switch = 8)] = 'Switch'),
  (t[(t.InputNumber = 9)] = 'InputNumber'),
  (t[(t.MultiTrackSelector = 10)] = 'MultiTrackSelector'),
  (t[(t.None = 11)] = 'None'),
  (t[(t.FileSelector = 12)] = 'FileSelector'),
  (t[(t.MultiSourceAudioSelector = 13)] = 'MultiSourceAudioSelector'),
  (t[(t.AudioRecorder = 14)] = 'AudioRecorder'),
  (t[(t.SelectList = 15)] = 'SelectList'),
  t
))(B || {});
async function Sh(t) {
...
var lh = /* @__PURE__ */ (t => (
  (t[(t.SelectedTrackIds = 1)] = 'SelectedTrackIds'),
  (t[(t.SelectedClipInfos = 2)] = 'SelectedClipInfos'),
  (t[(t.TickAtPlayhead = 3)] = 'TickAtPlayhead'),
  (t[(t.EditingClipInfo = 4)] = 'EditingClipInfo'),
  (t[(t.EditingNoteIds = 5)] = 'EditingNoteIds'),
  (t[(t.TickAtPlayheadSnappedToBeat = 6)] = 'TickAtPlayheadSnappedToBeat'),
  t
))(lh || {});
export {
  un as AudioPlugin,
